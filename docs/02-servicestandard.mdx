...
description: Wie KoliBri die Qualitätsanforderungen des Servicestandards (DIN SPEC 66336) für digitale Verwaltungsleistungen durch standardisierte und barrierefreie Komponenten operationalisiert.
tags:
  - Barrierefreiheit
  - Standards
  - DIN SPEC 66336
...
Für Prinzip 6 verlangt der Servicestandard (DIN SPEC 66336) die Einhaltung der [BITV 2.0]. Diese setzt die europäische Norm [EN 301 549] um, die wiederum die [WCAG 2.1] (Stufe AA) einschließt. KoliBri erfüllt diese Anforderungen durch die Konstruktion der Komponenten:
