import {KolCard, KolIcon, KolLink,} from '@public-ui/react-v19';

# Designer

<div className="grid grid-cols-2">
	<KolCard _label="Eigenes Theme erstellen" _level={2}>
		<KolLink _label="Klicken Sie hier, um den Designer in einem neuen Browser-Fenster zu öffnen." _href="/designer" _target="_blank" _icons={{ left:'codicon codicon-paintcan' }} />
	</KolCard>
</div>
...
<kol-alert _label="Designer oder Scss" _type="info" _variant="card">
	KoliBri bietet zum Erstellen von Themes auch einen <KolLink _label="Scss" _href="/docs/concepts/styling/scss" />-Ansatz an. Je nach persönlichen Präferenzen kann der Designer oder Scss verwendet werden.
</kol-alert>
...
<kol-link-group _label="Überschrift" _links="[{'_label':'Link 1', '_icon':'icofont-home','_href':'test'},{'_label':'Link 2', '_icon':'icofont-phone','_href':'test'}]" _list-style-type="none"></kol-link-group>
...
4. Beachten Sie, dass Sie über den KoliBri-Designer nur Komponenten stylen können, die sich innerhalb eines Shadow-Doms befinden. Es wäre beim Beispiel <b>kol-link-group</b> nicht möglich, das Element <b><kol-link-group _label=""></kol-link-group></b> selbst zu stylen, da sich dieses nicht innerhalb eines Shadow-Doms befindet.
