...
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/mermaid-306576ad.js
var mermaid_306576ad = __webpack_require__(89252);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/createText-b670c180.js
...
const createText = (el, text = "", {
  ...
  mermaid_306576ad.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,mermaid_306576ad.I)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
/* harmony export */ });
/* harmony import */ var _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(89252);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56928);
/* harmony import */ var _createText_b670c180_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9062);
/* harmony import */ var _svgDraw_b48a99d5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2932);
...
/* harmony import */ var _edges_c959041a_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(38500);
...
/* harmony import */ var _createText_b670c180_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9062);
...
/* harmony import */ var _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(89252);
/* harmony import */ var _index_892ad7fb_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(48065);
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles_1e36f090_js__WEBPACK_IMPORTED_MODULE_7__.D) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(itemId, (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.c)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeTextOrArray(newNode.description, (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.c)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles_1e36f090_js__WEBPACK_IMPORTED_MODULE_7__.a ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case _styles_1e36f090_js__WEBPACK_IMPORTED_MODULE_7__.b:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_1e36f090_js__WEBPACK_IMPORTED_MODULE_7__.D:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_1e36f090_js__WEBPACK_IMPORTED_MODULE_7__.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(item.description, (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.c)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles_1e36f090_js__WEBPACK_IMPORTED_MODULE_7__.c) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = async function(text, id, _version, diag) {
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  diag.db.getDirection();
  const { securityLevel, state: conf } = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.c)();
  const nodeSpacing = conf.nodeSpacing || 50;
  const rankSpacing = conf.rankSpacing || 50;
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.info(diag.db.getRootDocV2());
  ...
  await (0,_index_892ad7fb_js__WEBPACK_IMPORTED_MODULE_9__.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
  const bounds = svg.node().getBBox();
  const width = bounds.width + padding * 2;
  const height = bounds.height + padding * 2;
  svg.attr("class", CSS_DIAGRAM);
  const svgBounds = svg.node().getBBox();
  (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.i)(svg, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_8__.l.debug(`viewBox ${vBox}`);
