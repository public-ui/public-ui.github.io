...
/* harmony export */ });
/* harmony import */ var _styles_237fcbdf_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(50582);
...
/* harmony import */ var _index_05087a90_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(57997);
...
const sanitizeText = (txt) => _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(txt, (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addNamespaces = function(namespaces, g, _id, diagObj) {
  ...
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info(namespaces);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info("setNode", node);
  });
};
const addClasses = function(classes, g, _id, diagObj, parent) {
  const keys = Object.keys(classes);
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info(classes);
  keys.forEach(function(id) {
    var _a, _b;
...
const addNotes = function(notes, g, startEdgeId, classes) {
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.o)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.o)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.k)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing class - ", id);
  const conf2 = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart ?? (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().class;
  const securityLevel = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info("config:", conf2);
  ...
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.l.info(relations);
  ...
  await (0,_index_05087a90_js__WEBPACK_IMPORTED_MODULE_8__.r)(
    element,
    g,
  ...
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_7__.p)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
const diagram = {
  parser: _styles_237fcbdf_js__WEBPACK_IMPORTED_MODULE_9__.p,
  db: _styles_237fcbdf_js__WEBPACK_IMPORTED_MODULE_9__.d,
  renderer,
  styles: _styles_237fcbdf_js__WEBPACK_IMPORTED_MODULE_9__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_237fcbdf_js__WEBPACK_IMPORTED_MODULE_9__.d.clear();
  }
};
...
let functions = [];
const sanitizeText = (txt) => _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.c)());
const parseDirective = function(statement, context, type) {
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.m.parseDirective(this, statement, context, type);
};
...
const clear = function() {
  ...
  namespaces = {};
  namespaceCounter = 0;
  (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.v)();
};
...
const addRelation = function(relation) {
  _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(
    relation.relationTitle1.trim(),
    (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.c)()
  );
  relation.relationTitle2 = _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(
...
const setLink = function(ids, linkStr, target) {
  const config = (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (_id[0].match(/\d/)) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (classes[id] !== void 0) {
      classes[id].link = _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
    ...
    functions.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.u.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
const db = {
  parseDirective,
  setAccTitle: _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.s,
  getAccTitle: _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.g,
  getAccDescription: _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.a,
  setAccDescription: _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.b,
  getConfig: () => (0,_mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.c)().class,
  addClass,
  bindFunctions,
  clear,
  getClass,
  ...
  setTooltip,
  lookUpDomId,
  setDiagramTitle: _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.r,
  getDiagramTitle: _mermaid_a953d906_js__WEBPACK_IMPORTED_MODULE_1__.t,
  setClassLabel,
  addNamespace,
