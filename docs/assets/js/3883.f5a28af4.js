 ...
 * KoliBri - The accessible HTML-Standard
 */
const validateAriaCurrent=(a,e)=>{(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_0__.a)(a,"_ariaCurrent",(a=>"date"===a||"location"===a||"page"===a||"step"===a||"time"===a||!0===a),new Set(["String {data, location, page, step, time}","boolean"]),e)},validateAriaSelected=(a,e)=>{(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_0__.b)(a,"_ariaSelected",e)};
...
/* harmony import */ var _tab_index_ff5374b8_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(80834);
/* harmony import */ var _button_link_283b2d32_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(49007);
/* harmony import */ var _controller_ec771280_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(86057);
/* harmony import */ var _label_559ca626_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12700);
/* harmony import */ var _aria_selected_efb464e1_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(90807);
/* harmony import */ var _disabled_6200e69c_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26885);
/* harmony import */ var _hide_label_2baeb5c5_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(66094);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const defaultStyleCss=":host{--a11y-min-size:44px;font-size:inherit}*{hyphens:auto;letter-spacing:inherit;word-break:break-word;word-spacing:inherit}[role='button'],button:not([role='link']),kol-input .input{min-height:var(--a11y-min-size);min-width:var(--a11y-min-size)}a,button,h1,h2,h3,h4,h5,h6,input,option,select,textarea{font-family:inherit;font-size:inherit}:is(a,button){background-color:transparent;border:none;margin:0;padding:0;width:100%;}:host{max-width:100%}*{box-sizing:border-box}kol-span-wc{display:grid;place-items:center}kol-span-wc>span{display:flex;place-items:center}a,button{cursor:pointer}button,input,option,select,textarea{font-family:inherit}.icon-only>kol-span-wc>span>span{display:none}:host{display:flex;position:relative}.main-button{flex-grow:1;text-align:left}.main-button kol-span-wc{place-items:start}.secondary-button button{height:100%}.horizontal-line{background-color:rgba(0, 0, 0, 0.2);border-radius:2px;height:70%;margin-block:auto;width:1px}.popover{height:0;left:0;min-width:100%;overflow:hidden;position:absolute;top:100%;transition:height 0.3s ease-in-out}.popover-content{inset:0 0 auto 0;min-width:100%;position:absolute}",KolSplitButton=class{constructor(t){(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.r)(this,t),this.clickHandler=t=>{"function"==typeof this.state._on.onClick?this.state._on.onClick(t):this.toggleDropdown()},this.openDropdown=()=>{this.dropdown&&this.dropdownContent&&(this.dropdown.style.height=`${this.dropdownContent.clientHeight}px`,this.state=Object.assign(Object.assign({},this.state),{_showDropdown:!0}))},this.closeDropdown=()=>{this.dropdown&&this.dropdownContent&&(this.dropdown.style.height="",this.state=Object.assign(Object.assign({},this.state),{_showDropdown:!1}))},this.toggleDropdown=t=>{("boolean"==typeof t?t:!this.state._showDropdown)?this.openDropdown():this.closeDropdown()},this.forceCounter=100,this.forceOpenDropdown=()=>{var t;this.forceCounter>0&&((null===(t=this.dropdownContent)||void 0===t?void 0:t.clientHeight)?this.openDropdown():setTimeout(this.forceOpenDropdown,10),this.forceCounter--)},this.catchDropdownElements=t=>{t&&(this.dropdown=t,setTimeout((()=>{this.dropdownContent=t.firstChild,this._showDropdown&&this.forceOpenDropdown()})))},this._accessKey=void 0,this._ariaControls=void 0,this._ariaCurrent=void 0,this._ariaExpanded=void 0,this._ariaLabel=void 0,this._ariaSelected=void 0,this._customClass=void 0,this._disabled=!1,this._hideLabel=!1,this._icon=void 0,this._iconOnly=void 0,this._label=void 0,this._on=void 0,this._role=void 0,this._showDropdown=!1,this._tabIndex=void 0,this._tooltipAlign="top",this._type="button",this._value=void 0,this._variant="normal",this.state={_icon:"",_label:"",_on:{},_showDropdown:!1}}render(){return (0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.H,null,(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-button-wc",{class:{"main-button":!0,button:!0,[this._variant]:"custom"!==this._variant,[this._customClass]:"custom"===this._variant&&"string"==typeof this._customClass&&this._customClass.length>0},_accessKey:this._accessKey,_ariaControls:this._ariaControls,_ariaCurrent:this._ariaCurrent,_ariaExpanded:this._ariaExpanded,_ariaLabel:this._ariaLabel,_ariaSelected:this._ariaSelected,_customClass:this._customClass,_disabled:this._disabled,_icon:this._icon,_hideLabel:this._hideLabel,_label:this._label,_on:{onClick:this.clickHandler},_role:this._role,_tabIndex:this._tabIndex,_tooltipAlign:this._tooltipAlign,_type:this._type,_value:this._value,_variant:this._variant}),(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{class:"horizontal-line"}),(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-button-wc",{class:"secondary-button",_disabled:this._disabled,_hideLabel:!0,_icon:"codicon codicon-triangle-down",_label:"dropdown "+(this.state._showDropdown?"schließen":"öffnen"),_on:{onClick:()=>this.toggleDropdown()}}),(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{class:"popover",ref:this.catchDropdownElements},(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{class:"popover-content"},(0,_index_6ad587d0_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot",null))))}validateAccessKey(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.w)(this,"_accessKey",t)}validateAriaControls(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.w)(this,"_ariaControls",t)}validateAriaCurrent(t){(0,_aria_selected_efb464e1_js__WEBPACK_IMPORTED_MODULE_2__.v)(this,t)}validateAriaExpanded(t){(0,_disabled_6200e69c_js__WEBPACK_IMPORTED_MODULE_3__.v)(this,t)}validateAriaLabel(t){(0,_label_559ca626_js__WEBPACK_IMPORTED_MODULE_4__.a)(this,t)}validateAriaSelected(t){(0,_aria_selected_efb464e1_js__WEBPACK_IMPORTED_MODULE_2__.a)(this,t)}validateCustomClass(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.w)(this,"_customClass",t,{defaultValue:void 0})}validateDisabled(t){(0,_disabled_6200e69c_js__WEBPACK_IMPORTED_MODULE_3__.a)(this,t),t&&(0,_a11y_tipps_2e27f8e6_js__WEBPACK_IMPORTED_MODULE_5__.g)()}validateHideLabel(t){(0,_hide_label_2baeb5c5_js__WEBPACK_IMPORTED_MODULE_6__.v)(this,t)}validateIcon(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.w)(this,"_icon",t)}validateIconOnly(t){this.validateHideLabel(t)}validateLabel(t){(0,_label_559ca626_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,t)}validateOn(t){"object"==typeof t&&null!==t&&(this.state=Object.assign(Object.assign({},this.state),{_on:t}))}validateRole(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.w)(this,"_role",t)}validateShowDropdown(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.b)(this,"_showDropdown",t),this.toggleDropdown(t)}validateTabIndex(t){(0,_tab_index_ff5374b8_js__WEBPACK_IMPORTED_MODULE_7__.v)(this,t)}validateTooltipAlign(t){(0,_button_link_283b2d32_js__WEBPACK_IMPORTED_MODULE_8__.w)(this,"_tooltipAlign",t)}validateType(t){(0,_controller_ec771280_js__WEBPACK_IMPORTED_MODULE_9__.a)(this,"_type",t)}validateValue(t){(0,_prop_validators_f81af56e_js__WEBPACK_IMPORTED_MODULE_1__.s)(this,"_value",t)}validateVariant(t){(0,_controller_ec771280_js__WEBPACK_IMPORTED_MODULE_9__.w)(this,"_variant",t)}componentWillLoad(){this.validateAccessKey(this._accessKey),this.validateAriaControls(this._ariaControls),this.validateAriaCurrent(this._ariaCurrent),this.validateAriaExpanded(this._ariaExpanded),this.validateAriaLabel(this._ariaLabel),this.validateAriaSelected(this._ariaSelected),this.validateCustomClass(this._customClass),this.validateDisabled(this._disabled),this.validateHideLabel(this._hideLabel||this._iconOnly),this.validateIcon(this._icon),this.validateLabel(this._label),this.validateOn(this._on),this.validateRole(this._role),this.validateShowDropdown(this._showDropdown),this.validateTabIndex(this._tabIndex),this.validateTooltipAlign(this._tooltipAlign),this.validateType(this._type),this.validateValue(this._value),this.validateVariant(this._variant)}static get watchers(){return{_accessKey:["validateAccessKey"],_ariaControls:["validateAriaControls"],_ariaCurrent:["validateAriaCurrent"],_ariaExpanded:["validateAriaExpanded"],_ariaLabel:["validateAriaLabel"],_ariaSelected:["validateAriaSelected"],_customClass:["validateCustomClass"],_disabled:["validateDisabled"],_hideLabel:["validateHideLabel"],_icon:["validateIcon"],_iconOnly:["validateIconOnly"],_label:["validateLabel"],_on:["validateOn"],_role:["validateRole"],_showDropdown:["validateShowDropdown"],_tabIndex:["validateTabIndex"],_tooltipAlign:["validateTooltipAlign"],_type:["validateType"],_value:["validateValue"],_variant:["validateVariant"]}}};KolSplitButton.style={default:defaultStyleCss};
