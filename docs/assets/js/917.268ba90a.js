...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.3.1/node_modules/mermaid/dist/sankeyDiagram-91977475.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_306576ad.e.sanitizeText(ID, (0,mermaid_306576ad.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_306576ad.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_306576ad.c)();
  const defaultSankeyConfig = mermaid_306576ad.H.sankey;
  let sandboxElement;
  ...
  (0,mermaid_306576ad.i)(svg, height, width, useMaxWidth);
