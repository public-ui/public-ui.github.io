...
/* harmony import */ var _dev_utils_d751d0cd_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17608);
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8596);
/* harmony import */ var _label_20475610_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21200);
/* harmony import */ var _open_5b527658_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21116);
/* harmony import */ var _href_74f1c87f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(24339);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const validateActive=(e,t,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.b)(e,"_active",t,a)},KolTreeItemWc=class{constructor(e){(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.r)(this,e),this.groupId=`tree-group-${(0,_dev_utils_d751d0cd_js__WEBPACK_IMPORTED_MODULE_2__.n)()}`,this.renderIcon=e=>(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)(_component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_3__.g,{class:"toggle-button-icon",_label:e.label,_icons:e.icon}),this.level=void 0,this.state={_active:!1,_hasChildren:!1,_href:"",_label:"",_open:!1},this._active=void 0,this._label=void 0,this._open=void 0,this._href=void 0}render(){const{_href:e,_active:t,_hasChildren:a,_open:i,_label:s}=this.state;return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.H,{key:"a7478410c633314ba5b7a9e8588b5b9484efeb94",onSlotchange:this.handleSlotchange.bind(this),class:"kol-tree-item-wc"},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)("li",{key:"6c3ad7b0e013ec83d92f0d05a222d0696aa98729",class:"tree-item",style:{"--level":`${this.level}`}},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)(_component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_3__.n,{key:"fbd0b31027e032f6df61652df29a0b37ef67a104",class:{"tree-link":!0,"first-level":0===this.level,active:Boolean(t)},_href:e,_label:"",_role:"treeitem",_tabIndex:t?0:-1,_ariaExpanded:i,_ariaOwns:a?this.groupId:void 0,ref:e=>this.linkElement=e},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)("span",{key:"361d16b78885085be82c83e6fe4b8bd83e8274d7",slot:"expert"},a&&(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)("span",{key:"3a742c6ea9fa940854cb21f1607ab0490c091558",class:"toggle-button",onClick:e=>i?void this.handleCollapseClick(e):void this.handleExpandClick(e)},this.renderIcon({icon:"codicon codicon-"+(i?"chevron-down":"chevron-right"),label:i?"Vorschläge öffnen":"Vorschläge schließen"}))," ",s)),(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)("ul",{key:"087a87f28d8f06d72cee95f9ab553f7f79e16496",hidden:!a||!i,role:"group",id:this.groupId},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot",{key:"8e286b2265806859a9bd61809c6387331df607f3"}))))}validateActive(e){validateActive(this,e||!1)}validateLabel(e){(0,_label_20475610_js__WEBPACK_IMPORTED_MODULE_4__.v)(this,e)}validateOpen(e){(0,_open_5b527658_js__WEBPACK_IMPORTED_MODULE_5__.v)(this,e)}validateHref(e){(0,_href_74f1c87f_js__WEBPACK_IMPORTED_MODULE_6__.v)(this,e)}componentWillLoad(){this.validateActive(this._active),this.validateLabel(this._label),this.validateOpen(this._open),this.validateHref(this._href),this.checkForChildren(),this.determineTreeItemDepth()}determineTreeItemDepth(){let e=0,t=this.host.parentNode.host.parentNode;for(;null!==t&&t.tagName.toLowerCase()!==_component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_3__.y&&t!==document.body;)t=t.parentElement,e+=1;this.level=e}handleSlotchange(){this.checkForChildren()}checkForChildren(){var e,t;this.state=Object.assign(Object.assign({},this.state),{_hasChildren:Boolean(null===(t=null===(e=this.host.querySelector("slot"))||void 0===e?void 0:e.assignedElements)||void 0===t?void 0:t.call(e).length)})}async focusLink(){await this.linkElement.kolFocus()}async handleExpandClick(e){e.preventDefault(),await this.linkElement.kolFocus(),await this.expand()}async expand(){this.state._hasChildren&&(this.state=Object.assign(Object.assign({},this.state),{_open:!0}))}async handleCollapseClick(e){e.preventDefault(),this.linkElement.focus(),await this.collapse()}async collapse(){this.state._hasChildren&&(this.state=Object.assign(Object.assign({},this.state),{_open:!1}))}async isOpen(){var e;return null!==(e=this.state._open)&&void 0!==e&&e}get host(){return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_1__.g)(this)}static get watchers(){return{_active:["validateActive"],_label:["validateLabel"],_open:["validateOpen"],_href:["validateHref"]}}};
