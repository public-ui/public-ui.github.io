...
/* harmony export */ });
/* harmony import */ var _a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12484);
/* harmony import */ var _dev_utils_157f0499_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91548);
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16038);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const searchFormElement=e=>{for((0,_dev_utils_157f0499_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&((0,_a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_1__.d)("↓ Search form element start."),console.log(e));e instanceof HTMLElement&&"FORM"!==e.tagName&&"KOL-FORM"!==e.tagName;)e=e.parentElement instanceof HTMLElement?e.parentElement:e.parentNode instanceof ShadowRoot?e.parentNode.host:null,(0,_dev_utils_157f0499_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&console.log(e);return (0,_dev_utils_157f0499_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&(0,_a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_1__.d)("↑ Search form element finished."),e},propagateResetEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new Event("reset",{bubbles:!0,cancelable:!0});if("FORM"===t.tagName)(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,t),t.dispatchEvent(e);else if("KOL-FORM"===t.tagName){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.K.querySelector("form",t));const o=t;"object"==typeof o._on&&null!==typeof o._on&&"function"==typeof o._on.onReset&&o._on.onReset(e)}}},propagateSubmitEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new SubmitEvent("submit",{bubbles:!0,cancelable:!0,submitter:t});if("FORM"===t.tagName)(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,t),t.dispatchEvent(e);else if("KOL-FORM"===t.tagName){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.K.querySelector("form",t));const o=t;"object"==typeof o._on&&null!==typeof o._on&&"function"==typeof o._on.onSubmit&&o._on.onSubmit(e)}}};
...
/* harmony import */ var _a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12484);
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16038);
/* harmony import */ var _controller_icon_26c0e34a_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99696);
/*!
 * KoliBri - The accessible HTML-Standard
 */
class InputPasswordController extends _controller_icon_26c0e34a_js__WEBPACK_IMPORTED_MODULE_0__.I{constructor(e,t,a){super(e,t,a),this.handleHiddenLabelAndRequired=()=>{!0===this.component.state._hideLabel&&!0===this.component.state._required?((0,_a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_1__.d)("[KolInput*] Wenn man das Label ausblendet, dann kann der sehende Nutzer:in nicht mehr erkennen, ob die Eingabe erforderlich ist."),this.hideLabel=!1):this.hideLabel=!0===this.component.state._hideLabel},this.component=e}validateAutoComplete(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.component,"_autoComplete",(e=>"string"==typeof e&&("on"===e||"off"===e)),new Set(["on | off"]),e)}validateHideLabel(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.component,"_hideLabel",e,{hooks:{afterPatch:this.handleHiddenLabelAndRequired}})}validateMaxLength(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.component,"_maxLength",e,{min:0})}validatePattern(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.w)(this.component,"_pattern",e)}validatePlaceholder(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.w)(this.component,"_placeholder",e)}validateReadOnly(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.component,"_readOnly",e)}validateRequired(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.component,"_required",e,{hooks:{afterPatch:this.handleHiddenLabelAndRequired}})}validateSize(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.component,"_size",e,{min:1})}validateValue(e){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__.w)(this.component,"_value",e)}componentWillLoad(){super.componentWillLoad(),this.validateAutoComplete(this.component._autoComplete),this.validateMaxLength(this.component._maxLength),this.validatePattern(this.component._pattern),this.validatePlaceholder(this.component._placeholder),this.validateReadOnly(this.component._readOnly),this.validateRequired(this.component._required),this.validateSize(this.component._size),this.validateValue(this.component._value)}onBlur(e){this.component.state=Object.assign(Object.assign({},this.component.state),{_placeholder:this.placeholderCache}),this.placeholderCache=void 0,super.onBlur(e)}onFocus(e){this.placeholderCache=this.component.state._placeholder,this.component.state=Object.assign(Object.assign({},this.component.state),{_placeholder:void 0}),super.onFocus(e)}}
...
/* harmony export */ });
/* harmony import */ var _a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12484);
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16038);
/* harmony import */ var _tab_index_eff012a1_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44454);
/* harmony import */ var _dev_utils_157f0499_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91548);
/*!
 * KoliBri - The accessible HTML-Standard
 */
...
/* harmony export */ });
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16038);
/* harmony import */ var _controller_3e94c3f2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(49565);
/*!
 * KoliBri - The accessible HTML-Standard
 */
class InputTextEmailController extends _controller_3e94c3f2_js__WEBPACK_IMPORTED_MODULE_0__.I{constructor(t,o,e){super(t,o,e),this.component=t}validateList(t){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_1__.d)(this.component,"_list",(t=>"string"==typeof t),t)}componentWillLoad(){super.componentWillLoad(),this.validateList(this.component._list)}}class InputTextController extends InputTextEmailController{constructor(t,o,e){super(t,o,e),this.hasError=!1,this.hasList=!1,this.component=t}validateType(t){(0,_prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_1__.a)(this.component,"_type",(t=>"string"==typeof t&&("text"===t||"search"===t||"url"===t||"tel"===t)),new Set(["String {text, search, url, tel}"]),t)}componentWillLoad(){super.componentWillLoad(),this.validateType(this.component._type)}}
...
/* harmony export */ });
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16038);
/* harmony import */ var _reuse_3a02afb9_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(55100);
/* harmony import */ var _icon_dfcf642a_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(32242);
/* harmony import */ var _controller_53ddde7c_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(81838);
/*!
 * KoliBri - The accessible HTML-Standard
 */
...
/* harmony export */ });
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16038);
/*!
 * KoliBri - The accessible HTML-Standard
 */
...
/* harmony export */ });
/* harmony import */ var _a11y_tipps_1cea9822_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12484);
/* harmony import */ var _prop_validators_e15a584f_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16038);
/*!
 * KoliBri - The accessible HTML-Standard
 */
