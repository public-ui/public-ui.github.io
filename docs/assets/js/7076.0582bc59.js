...
/* harmony export */ });
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6951);
/* harmony import */ var _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(32233);
/* harmony import */ var _config_5161385b_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94214);
/* harmony import */ var _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49470);
/* harmony import */ var _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(98762);
...
/* harmony export */ });
/* harmony import */ var _flowDb_e993bcaf_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(72217);
...
/* harmony import */ var _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(94214);
/* harmony import */ var dagre_d3_es__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(91403);
/* harmony import */ var dagre_d3_es_src_dagre_js_util_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(91476);
/* harmony import */ var dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(79182);
/* harmony import */ var _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(32233);
/* harmony import */ var _setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(96026);
/* harmony import */ var dagre_d3_es_src_dagre_js_intersect_intersect_polygon_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(28278);
/* harmony import */ var dagre_d3_es_src_dagre_js_intersect_intersect_rect_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(69474);
/* harmony import */ var _styles_a0ac66d3_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(35420);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(54972);
/* harmony import */ var moment_mini__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75696);
...
function question(parent, bbox, node) {
  ...
  node.intersect = function(point) {
    return (0,dagre_d3_es_src_dagre_js_intersect_intersect_polygon_js__WEBPACK_IMPORTED_MODULE_8__/* .intersectPolygon */ .A)(node, points, point);
  };
  return shapeSvg;
}
...
function stadium(parent, bbox, node) {
  ...
  node.intersect = function(point) {
    return (0,dagre_d3_es_src_dagre_js_intersect_intersect_rect_js__WEBPACK_IMPORTED_MODULE_9__/* .intersectRect */ .q)(node, point);
  };
  return shapeSvg;
}
...
function cylinder(parent, bbox, node) {
  ...
  node.intersect = function(point) {
    const pos = (0,dagre_d3_es_src_dagre_js_intersect_intersect_rect_js__WEBPACK_IMPORTED_MODULE_9__/* .intersectRect */ .q)(node, point);
    const x = pos.x - node.x;
    if (rx != 0 && (Math.abs(x) < node.width / 2 || Math.abs(x) == node.width / 2 && Math.abs(pos.y - node.y) > node.height / 2 - ry)) {
      let y = ry * ry * (1 - x * x / (rx * rx));
      if (y != 0) {
...
const addVertices = function(vert, g, svgId, root, _doc, diagObj) {
  const svg = !root ? (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys)(`[id="${svgId}"]`) : root.select(`[id="${svgId}"]`);
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__.m)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    if ((0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.j)((0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.g)().flowchart.htmlLabels)) {
      const node = {
      ...
      vertexNode = (0,dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_12__/* .addHtmlLabel */ .a)(svg, node).node();
      vertexNode.parentNode.removeChild(vertexNode);
    } else {
      const svgLabel = doc.createElementNS("http://www.w3.org/2000/svg", "text");
      svgLabel.setAttribute("style", styles.labelStyle.replace("color:", "fill:"));
      const rows = vertexText.split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.d.lineBreakRegex);
      for (const row of rows) {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.warn("Adding node", vertex.id, vertex.domId);
...
const addEdges = function(edges, g, diagObj) {
  ...
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__.m)(edges.defaultStyle);
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.style !== void 0) {
      const styles = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__.m)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    } else {
      switch (edge.stroke) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .c_6);
    } else {
      edgeData.curve = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_10__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.j)((0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.g)().flowchart.htmlLabels)) {
        ...
        edgeData.label = edge.text.replace(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.d.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const getClasses = function(text, diagObj) {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.info("Extracting classes");
  diagObj.db.clear();
  try {
    diagObj.parse(text);
    return diagObj.db.getClasses();
  } catch (e) {
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.error(e);
    return {};
  }
};
const draw = function(text, id, _version, diagObj) {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.info("Drawing flowchart");
  diagObj.db.clear();
  const { securityLevel, flowchart: conf2 } = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.g)();
  let sandboxElement;
  ...
  try {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("Parsing failed");
  }
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.warn("Get vertices", vert);
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    ...
    for (let j = 0; j < subG.nodes.length; j++) {
      _config_5161385b_js__WEBPACK_IMPORTED_MODULE_11__.l.warn(
        "Setting subgraph",
        subG.nodes[j],
  ...
  const render$1 = new dagre_d3_es__WEBPACK_IMPORTED_MODULE_2__/* .render */ .sY();
  flowChartShapes.addToRender(render$1);
  render$1.arrows().none = function normal(parent, id2, edge, type) {
    const marker = parent.append("marker").attr("id", id2).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerUnits", "strokeWidth").attr("markerWidth", 8).attr("markerHeight", 6).attr("orient", "auto");
    const path = marker.append("path").attr("d", "M 0 0 L 0 0 L 0 0 z");
    (0,dagre_d3_es_src_dagre_js_util_js__WEBPACK_IMPORTED_MODULE_13__/* .applyStyle */ .bg)(path, edge[type + "Style"]);
  };
  ...
  for (i = 0; i < subGraphs.length; i++) {
    ...
    if (subG.title !== "undefined") {
      ...
      const cluster = (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys)(clusterEl[0]);
  ...
  (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_14__.s)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  const keys = Object.keys(vert);
...
const diagram = {
  parser: _flowDb_e993bcaf_js__WEBPACK_IMPORTED_MODULE_15__.p,
  db: _flowDb_e993bcaf_js__WEBPACK_IMPORTED_MODULE_15__.f,
  renderer: _styles_a0ac66d3_js__WEBPACK_IMPORTED_MODULE_16__.f,
  styles: _styles_a0ac66d3_js__WEBPACK_IMPORTED_MODULE_16__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    ...
    _flowDb_e993bcaf_js__WEBPACK_IMPORTED_MODULE_15__.f.clear();
    _flowDb_e993bcaf_js__WEBPACK_IMPORTED_MODULE_15__.f.setGen("gen-1");
  }
};
...
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(39564);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6951);
/* harmony import */ var _flowDb_e993bcaf_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72217);
/* harmony import */ var _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(94214);
/* harmony import */ var _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32233);
/* harmony import */ var _index_64e46a5f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(58811);
/* harmony import */ var dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(79182);
/* harmony import */ var _setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(96026);
