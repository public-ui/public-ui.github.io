...
/* harmony export */   v: () => (/* binding */ validateHasCloser)
/* harmony export */ });
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8596);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const validateHasCloser=(a,o)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.b)(a,"_hasCloser",o)};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   kol_alert_wc: () => (/* binding */ KolAlertWc)
/* harmony export */ });
/* harmony import */ var _index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41336);
/* harmony import */ var _i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(53844);
/* harmony import */ var _validation_e2c07abd_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(26080);
/* harmony import */ var _component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45016);
/* harmony import */ var _dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(72032);
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8596);
/* harmony import */ var _has_closer_5575cc91_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(45208);
/* harmony import */ var _label_20475610_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21200);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const alertTypeOptions=["default","info","success","warning","error"],alertVariantOptions=["card","msg"],Icon=a=>(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_1__.g,{class:"heading-icon",_label:"string"==typeof a.label&&a.label.length>0?"":a.ariaLabel,_icons:a.icon}),AlertIcon=a=>{switch(a.type){case"error":return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(Icon,{ariaLabel:(0,_i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__.t)("kol-error"),icon:"codicon codicon-error",label:a.label});case"info":return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(Icon,{ariaLabel:(0,_i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__.t)("kol-info"),icon:"codicon codicon-info",label:a.label});case"warning":return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(Icon,{ariaLabel:(0,_i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__.t)("kol-warning"),icon:"codicon codicon-warning",label:a.label});case"success":return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(Icon,{ariaLabel:(0,_i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__.t)("kol-success"),icon:"codicon codicon-pass",label:a.label});default:return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(Icon,{ariaLabel:(0,_i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__.t)("kol-message"),icon:"codicon codicon-comment",label:a.label})}},KolAlertWc=class{constructor(a){(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.r)(this,a),this.close=()=>{var a;void 0!==(null===(a=this._on)||void 0===a?void 0:a.onClose)&&this._on.onClose(new Event("Close"))},this.on={onClick:this.close},this.validateOnValue=a=>"object"==typeof a&&null!==a&&"function"==typeof a.onClose,this._alert=!1,this._hasCloser=!1,this._label=void 0,this._level=1,this._on=void 0,this._type="default",this._variant="msg",this.state={_level:1}}render(){var a;if(this.state._alert){try{_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_3__.L.debug(["Navigator should vibrate ...",navigator.vibrate([100,75,100,75,100])])}catch(a){_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_3__.L.debug("Navigator does not support vibration.")}setTimeout((()=>{this.validateAlert(!1)}),1e4)}return (0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.H,{key:"ecb2cd45b14f92cc1c337d2b81382a8cc820e869",class:{"kol-alert-wc":!0,alert:!0,[this.state._type]:!0,[this.state._variant]:!0,hasCloser:!!this.state._hasCloser},role:this.state._alert?"alert":void 0},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{key:"b190de9f62c33d970daabc1b5638132da33c936e",class:"heading"},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(AlertIcon,{key:"e1da8b194a13ec6f9270efc2234caadcee77e827",label:this.state._label,type:this.state._type}),(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{key:"7ffd000cfbe218c582791e8646ff5caf9bad5b25",class:"heading-content"},"string"==typeof this.state._label&&(null===(a=this.state._label)||void 0===a?void 0:a.length)>0&&(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_1__.b,{key:"f9e7c598243a4868b80b248fdf4dfdeed5d24a2b",_label:this.state._label,_level:this.state._level}),"msg"===this.state._variant&&(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{key:"b5b70319b6c7747872e9d8072a1fe7565938f7c1",class:"content"},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot",{key:"b75edf24762d861147d5ee5fa0701b4c5a30eed1"}))),this.state._hasCloser&&(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)(_component_names_068dc2ae_js__WEBPACK_IMPORTED_MODULE_1__.c,{key:"cd46afacd1afbc415e1184604b3b1ac9af901c97",class:"close",_hideLabel:!0,_icons:{left:{icon:"codicon codicon-close"}},_label:(0,_i18n_2cbb513e_js__WEBPACK_IMPORTED_MODULE_2__.t)("kol-close-alert",{placeholders:{label:this.state._label}}),_on:this.on,_tooltipAlign:"left"})),"card"===this.state._variant&&(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{key:"2a9670974b00907497abd255e02194301df0c0a2",class:"content"},(0,_index_b5e5a1b4_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot",{key:"9bd3de7e485b9865d5f74dfbce4f421d4b1dc9b5"})))}validateAlert(a){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,"_alert",a)}validateHasCloser(a){(0,_has_closer_5575cc91_js__WEBPACK_IMPORTED_MODULE_5__.v)(this,a)}validateLabel(a){(0,_label_20475610_js__WEBPACK_IMPORTED_MODULE_6__.v)(this,a)}validateLevel(a){(0,_validation_e2c07abd_js__WEBPACK_IMPORTED_MODULE_7__.w)(this,a)}validateOn(a){this.validateOnValue(a)&&(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_4__.s)(this,"_on",{onClose:a.onClose})}validateType(a){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_type",(a=>"string"==typeof a&&alertTypeOptions.includes(a)),new Set(`String {${alertTypeOptions.join(", ")}`),a)}validateVariant(a){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_variant",(a=>"string"==typeof a&&alertVariantOptions.includes(a)),new Set(`AlertVariant {${alertVariantOptions.join(", ")}`),a)}componentWillLoad(){this.validateAlert(this._alert),this.validateHasCloser(this._hasCloser),this.validateLabel(this._label),this.validateLevel(this._level),this.validateOn(this._on),this.validateType(this._type),this.validateVariant(this._variant)}static get watchers(){return{_alert:["validateAlert"],_hasCloser:["validateHasCloser"],_label:["validateLabel"],_level:["validateLevel"],_on:["validateOn"],_type:["validateType"],_variant:["validateVariant"]}}};
...
/* harmony export */ });
/* harmony import */ var _label_20475610_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21200);
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8596);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const watchHeadingLevel=(e,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.w)(e,"_level",(e=>"number"==typeof e&&_label_20475610_js__WEBPACK_IMPORTED_MODULE_1__.h.includes(e)),new Set([`Number {${_label_20475610_js__WEBPACK_IMPORTED_MODULE_1__.h.join(", ")}`]),a,{defaultValue:1,required:!0})};
