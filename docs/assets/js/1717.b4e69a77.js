...
const db = {
  parseDirective,
  getConfig: () => (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_4__.c)().journey,
  clear,
...
function drawActorLegend(diagram2) {
  const conf2 = (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_4__.c)().journey;
  let yPos = 60;
...
const conf = (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_4__.c)().journey;
...
const draw = function(text, id, version, diagObj) {
  ...
  (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_4__.i)(diagram2, height, width, conf2.useMaxWidth);
