...
/* harmony export */ });
/* harmony import */ var _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(90403);
/* harmony import */ var _mermaidAPI_0716c7c2_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(85866);
/* harmony import */ var _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(30513);
...
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21640);
/* harmony import */ var _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2332);
/* harmony import */ var _setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(34694);
...
const addEntity = function(name) {
  if (entities[name] === void 0) {
    ...
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new entity :", name);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added new relationship :", rel);
};
...
const erDb = {
  ...
  Identification,
  parseDirective,
  getConfig: () => (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.p)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", conf.fontSize + "px").text(entityName);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().er;
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing ER diagram");
  ...
  _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_9__.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,_setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_10__.c)(svg, height, width, conf.useMaxWidth);
