...
/* harmony export */ });
/* harmony import */ var _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(83143);
...
const drawEdge = function(elem, path, relation, conf, diagObj) {
  ...
  let labelPosition = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.u.calcLabelPosition(path.points);
  x = labelPosition.x;
  y = labelPosition.y;
  let p1_card_x, p1_card_y;
  let p2_card_x, p2_card_y;
  if (l % 2 !== 0 && l > 1) {
    let cardinality_1_point = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.u.calcCardinalityPosition(
      relation.relation.type1 !== "none",
      path.points,
      path.points[0]
    );
    let cardinality_2_point = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.u.calcCardinalityPosition(
      relation.relation.type2 !== "none",
      path.points,
      path.points[l - 1]
    );
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("cardinality_1_point " + JSON.stringify(cardinality_1_point));
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("cardinality_2_point " + JSON.stringify(cardinality_2_point));
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Rendering relation " + JSON.stringify(relation));
...
const drawClass = function(elem, classDef, conf, diagObj) {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Rendering class ", classDef, conf);
...
const getClassTitleString = function(classDef) {
  ...
  if (classDef.type) {
    classTitleString += "<" + (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.v)(classDef.type) + ">";
  }
  return classTitleString;
};
const drawNote = function(elem, note, conf, diagObj) {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Rendering note ", note, conf);
  const id = note.id;
  const noteInfo = {
    id,
    text: note.text,
  ...
  lines.forEach(function(line2) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`Adding line: ${line2}`);
...
const draw = function(text, id, _version, diagObj) {
  const conf = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.c)().class;
  idCache = {};
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Rendering diagram " + text);
  ...
  for (const key of keys) {
    ...
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Org height: " + node.height);
  }
  const relations = diagObj.db.getRelations();
  relations.forEach(function(relation) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.info(
  ...
  notes.forEach(function(note) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`Adding note: ${JSON.stringify(note)}`);
  ...
  g.nodes().forEach(function(v) {
    if (v !== void 0 && g.node(v) !== void 0) {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Node " + v + ": " + JSON.stringify(g.node(v)));
  ...
  g.edges().forEach(function(e) {
    if (e !== void 0 && g.edge(e) !== void 0) {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(g.edge(e)));
  ...
  (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.i)(diagram2, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`viewBox ${vBox}`);
...
const diagram = {
  parser: _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_7__.p,
  db: _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_7__.d,
  renderer,
  styles: _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_7__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_7__.d.clear();
  }
};
