...
/* harmony export */ });
/* harmony import */ var _dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7738);
/*!
...
/* harmony export */ });
/* harmony import */ var _prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60447);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const watchTooltipAlignment=(t,o,a)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_0__.a)(t,o,(t=>"top"===t||"right"===t||"bottom"===t||"left"===t),new Set(["TooltipAlignment {top, right, buttom, left}"]),a,{defaultValue:"top"})};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "a": () => (/* binding */ watchButtonVariant),
/* harmony export */   "w": () => (/* binding */ watchButtonType)
/* harmony export */ });
/* harmony import */ var _prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60447);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const watchButtonType=(t,a,o)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_0__.a)(t,a,(t=>"button"===t||"reset"===t||"submit"===t),new Set(["KoliBriButtonType {button, reset, submit}"]),o)},watchButtonVariant=(t,a,o)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_0__.a)(t,a,(t=>"primary"===t||"secondary"===t||"normal"===t||"danger"===t||"ghost"===t||"custom"===t),new Set(["KoliBriButtonVariant {primary, secondary, normal, danger, ghost, custom}"]),o,{defaultValue:"normal"})};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "a": () => (/* binding */ propergateResetEventToForm),
/* harmony export */   "p": () => (/* binding */ propergateSubmitEventToForm)
/* harmony export */ });
/* harmony import */ var _a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35407);
/* harmony import */ var _dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7738);
/* harmony import */ var _prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60447);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const searchFormElement=e=>{for((0,_dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&((0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_1__.d)("↓ Search form element start."),console.log(e));e instanceof HTMLElement&&"FORM"!==e.tagName&&"KOL-FORM"!==e.tagName;)e=e.parentElement instanceof HTMLElement?e.parentElement:e.parentNode instanceof ShadowRoot?e.parentNode.host:null,(0,_dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&console.log(e);return (0,_dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&(0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_1__.d)("↑ Search form element finished."),e},propergateResetEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new Event("reset",{bubbles:!0,cancelable:!0});if("FORM"===t.tagName)(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.d)(e,t),t.dispatchEvent(e);else if("KOL-FORM"===t.tagName){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.d)(e,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.K.querySelector("form",t));const o=t;"object"==typeof o._on&&null!==typeof o._on&&"function"==typeof o._on.onReset&&o._on.onReset(e)}}},propergateSubmitEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new SubmitEvent("submit",{bubbles:!0,cancelable:!0,submitter:t});if("FORM"===t.tagName)(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.d)(e,t),t.dispatchEvent(e);else if("KOL-FORM"===t.tagName){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.d)(e,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.K.querySelector("form",t));const o=t;"object"==typeof o._on&&null!==typeof o._on&&"function"==typeof o._on.onSubmit&&o._on.onSubmit(e)}}};
...
/* harmony export */ });
/* harmony import */ var _index_90999368_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90914);
/* harmony import */ var _button_link_0e3aab16_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(58716);
/* harmony import */ var _a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(35407);
/* harmony import */ var _dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7738);
/* harmony import */ var _prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(60447);
/* harmony import */ var _reuse_f9be4952_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9571);
/* harmony import */ var _tab_index_f5bd7bba_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(31298);
/* harmony import */ var _label_4e702e1f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13679);
/* harmony import */ var _controller_563ae343_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(59238);
/* harmony import */ var _controller_1e0ec378_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(56491);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const KolButtonWc=class{constructor(t){(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.r)(this,t),this.nonce=(0,_dev_utils_daaf2f39_js__WEBPACK_IMPORTED_MODULE_1__.n)(),this.catchRef=t=>{this.ref=t,(0,_reuse_f9be4952_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.host,this.ref)},this.onClick=t=>{var a,i;"submit"===this.state._type?(0,_controller_563ae343_js__WEBPACK_IMPORTED_MODULE_3__.p)({form:this.host,ref:this.ref}):"reset"===this.state._type?(0,_controller_563ae343_js__WEBPACK_IMPORTED_MODULE_3__.a)({form:this.host,ref:this.ref}):"function"==typeof(null===(a=this.state._on)||void 0===a?void 0:a.onClick)?((0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.d)(t,this.ref),null===(i=this.state._on)||void 0===i||i.onClick(t)):(0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_5__.d)("It was no button click callback configured!")},this._accessKey=void 0,this._ariaControls=void 0,this._ariaCurrent=void 0,this._ariaExpanded=void 0,this._ariaLabel="",this._ariaSelected=void 0,this._customClass=void 0,this._disabled=!1,this._icon=void 0,this._iconAlign="left",this._iconOnly=!1,this._id=void 0,this._label=void 0,this._on=void 0,this._role=void 0,this._tabIndex=void 0,this._tooltipAlign="top",this._type="button",this._variant="normal",this.state={_ariaLabel:"",_icon:{},_iconAlign:"left",_label:"",_on:{},_type:"button"}}render(){return (0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.H,null,(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("button",Object.assign({ref:this.catchRef,accessKey:this.state._accessKey,"aria-controls":this.state._ariaControls,"aria-current":(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.m)(this.state._ariaCurrent),"aria-expanded":(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.e)(this.state._ariaExpanded),"aria-label":!1===this.state._iconOnly?this.state._ariaLabel||this.state._label:void 0,"aria-labelledby":!0===this.state._iconOnly?this.nonce:void 0,"aria-selected":(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.m)(this.state._ariaSelected),class:{[this.state._variant]:"custom"!==this.state._variant,[this.state._customClass]:"custom"===this.state._variant&&"string"==typeof this.state._customClass&&this.state._customClass.length>0,"icon-only":!0===this.state._iconOnly},disabled:this.state._disabled,id:this.state._id},this.state._on,{onClick:this.onClick,role:this.state._role,style:{width:"inherit"},tabIndex:this.state._tabIndex,type:this.state._type}),(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-span-wc",{_icon:this._icon,_iconOnly:this._iconOnly,_label:this.state._ariaLabel||this.state._label},(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot",{name:"expert",slot:"expert"}))),!0===this.state._iconOnly&&(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-tooltip",{"aria-hidden":"true",_align:this.state._tooltipAlign,_id:this.nonce,_label:this.state._ariaLabel||this.state._label}))}validateAccessKey(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_accessKey",t)}validateAriaControls(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_ariaControls",t)}validateAriaCurrent(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.a)(this,"_ariaControls",(t=>!0===t||"date"===t||"location"===t||"page"===t||"step"===t||"time"===t),new Set(["boolean","String {data, location, page, step, time}"]),t)}validateAriaExpanded(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,"_ariaExpanded",t)}validateAriaLabel(t){(0,_label_4e702e1f_js__WEBPACK_IMPORTED_MODULE_6__.v)(this,t)}validateAriaSelected(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,"_ariaSelected",t)}validateCustomClass(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_customClass",t,{defaultValue:void 0})}validateDisabled(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,"_disabled",t),!0===t&&(0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_5__.b)()}validateIcon(t){(0,_tab_index_f5bd7bba_js__WEBPACK_IMPORTED_MODULE_7__.v)(this,t)}validateIconAlign(t){(0,_tab_index_f5bd7bba_js__WEBPACK_IMPORTED_MODULE_7__.w)(this,t)}validateIconOnly(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,"_iconOnly",t,{defaultValue:!1})}validateId(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_id",t)}validateLabel(t){(0,_label_4e702e1f_js__WEBPACK_IMPORTED_MODULE_6__.a)(this,t)}validateOn(t){"object"==typeof t&&null!==t&&(this.state=Object.assign(Object.assign({},this.state),{_on:t}))}validateRole(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.w)(this,"_role",t)}validateTabIndex(t){(0,_tab_index_f5bd7bba_js__WEBPACK_IMPORTED_MODULE_7__.a)(this,t)}validateTooltipAlign(t){(0,_button_link_0e3aab16_js__WEBPACK_IMPORTED_MODULE_8__.w)(this,"_tooltipAlign",t)}validateType(t){(0,_controller_1e0ec378_js__WEBPACK_IMPORTED_MODULE_9__.w)(this,"_type",t)}validateVariant(t){(0,_controller_1e0ec378_js__WEBPACK_IMPORTED_MODULE_9__.a)(this,"_variant",t)}componentWillLoad(){this.validateAccessKey(this._accessKey),this.validateAriaControls(this._ariaControls),this.validateAriaCurrent(this._ariaCurrent),this.validateAriaExpanded(this._ariaExpanded),this.validateAriaLabel(this._ariaLabel),this.validateAriaSelected(this._ariaSelected),this.validateCustomClass(this._customClass),this.validateDisabled(this._disabled),this.validateIcon(this._icon),this.validateIconOnly(this._iconOnly),this.validateId(this._id),this.validateLabel(this._label),this.validateOn(this._on),this.validateRole(this._role),this.validateTabIndex(this._tabIndex),this.validateTooltipAlign(this._tooltipAlign),this.validateType(this._type),this.validateVariant(this._variant)}get host(){return (0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.g)(this)}static get watchers(){return{_accessKey:["validateAccessKey"],_ariaControls:["validateAriaControls"],_ariaCurrent:["validateAriaCurrent"],_ariaExpanded:["validateAriaExpanded"],_ariaLabel:["validateAriaLabel"],_ariaSelected:["validateAriaSelected"],_customClass:["validateCustomClass"],_disabled:["validateDisabled"],_icon:["validateIcon"],_iconAlign:["validateIconAlign"],_iconOnly:["validateIconOnly"],_id:["validateId"],_label:["validateLabel"],_on:["validateOn"],_role:["validateRole"],_tabIndex:["validateTabIndex"],_tooltipAlign:["validateTooltipAlign"],_type:["validateType"],_variant:["validateVariant"]}}},removeNode=t=>{t instanceof Node&&setTimeout((()=>{var a,i;null===(a=t.parentElement)||void 0===a||a.removeChild(t),null===(i=t.parentNode)||void 0===i||i.removeChild(t)}))},KolSpanWc=class{constructor(t){(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.r)(this,t),this._icon=void 0,this._iconOnly=!1,this._label=void 0,this.state={_icon:{},_iconOnly:!1,_label:""}}render(){return (0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.H,{class:{"icon-only":this.state._iconOnly}},this.state._icon.top&&(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-icon",{class:{"icon top":!0},style:this.state._icon.top.style,_ariaLabel:"",_icon:this.state._icon.top.icon}),(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("span",{class:"flex items-center"},this.state._icon.left&&(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-icon",{class:{"icon left":!0,"mr-2":this.state._iconOnly},style:this.state._icon.left.style,_ariaLabel:"",_icon:this.state._icon.left.icon}),(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("span",null,!0!==this.state._iconOnly&&this.state._label.length>0?this.state._label:""),(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("span",{ref:this.state._label.length>0?removeNode:void 0},(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot",{name:"expert"})),this.state._icon.right&&(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-icon",{class:{"icon right":!0,"ml-2":this.state._iconOnly},style:this.state._icon.right.style,_ariaLabel:"",_icon:this.state._icon.right.icon})),this.state._icon.bottom&&(0,_index_90999368_js__WEBPACK_IMPORTED_MODULE_0__.h)("kol-icon",{class:{"icon bottom":!0},style:this.state._icon.bottom.style,_ariaLabel:"",_icon:this.state._icon.bottom.icon}))}validateIcon(t){(0,_tab_index_f5bd7bba_js__WEBPACK_IMPORTED_MODULE_7__.v)(this,t)}validateIconOnly(t){(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_4__.b)(this,"_iconOnly",t)}validateLabel(t){(0,_label_4e702e1f_js__WEBPACK_IMPORTED_MODULE_6__.a)(this,t)}componentWillLoad(){this.validateIcon(this._icon),this.validateIconOnly(this._iconOnly),this.validateLabel(this._label)}static get watchers(){return{_icon:["validateIcon"],_iconOnly:["validateIconOnly"],_label:["validateLabel"]}}};
...
/* harmony import */ var _a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35407);
/* harmony import */ var _prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60447);
/* harmony import */ var _validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5617);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const syncAriaLabelBeforePatch=(a,e,r,i)=>{const t=e.has("_ariaLabel")?e.get("_ariaLabel"):r.state._ariaLabel;if("string"==typeof t){const a=e.has("_label")?e.get("_label"):r.state._label;!1===(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.c)(a,t)&&("_ariaLabel"===i?e.set("_label",t):e.set("_ariaLabel",a),(0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_1__.e)("Das abweichende Aria-Label am Schalter ist nicht barrierefrei. Ein abweichendes Aria-Label muss aus Gründern der Barrierefreiheit für die Sprachsteuerung mit dem Label-Text beginnen."))}},validateAriaLabel=(a,e)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.w)(a,"_ariaLabel",e,{hooks:{beforePatch:syncAriaLabelBeforePatch}})},validateLabel=(a,e)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_2__.w)(a,"_label",e,{hooks:{beforePatch:syncAriaLabelBeforePatch},required:!0})};
...
/* harmony export */   "d": () => (/* binding */ setEventTargetAndStopPropagation),
/* harmony export */   "e": () => (/* binding */ mapBoolean2String),
/* harmony export */   "f": () => (/* binding */ watchNumber),
/* harmony export */   "g": () => (/* binding */ mapString2Unknown),
/* harmony export */   "h": () => (/* binding */ scrollBySelector),
/* harmony export */   "i": () => (/* binding */ emptyStringByArrayHandler),
...
/* harmony export */   "m": () => (/* binding */ mapStringOrBoolean2String),
 ...
 * KoliBri - The accessible HTML-Standard
 */
const propergateFocus=(o,s)=>{(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.i)(o)&&o&&(o.focus=o=>null==s?void 0:s.focus(o))};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "a": () => (/* binding */ validateTabIndex),
/* harmony export */   "i": () => (/* binding */ isIcon),
/* harmony export */   "v": () => (/* binding */ validateIcon),
/* harmony export */   "w": () => (/* binding */ watchIconAlign)
/* harmony export */ });
/* harmony import */ var _a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35407);
/* harmony import */ var _prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(60447);
/* harmony import */ var _validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5617);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const mapCustomIcon=(t,o,e)=>{(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.i)(e)?t[o]=e:(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(e,1)&&(t[o]={icon:e})},mapIconProp2State=(t,o)=>{let e={};if((0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t,1))if("right"===o)e={right:{icon:t}};else e={left:{icon:t}};else"object"==typeof t&&null!==t&&(mapCustomIcon(e,"top",t.top),mapCustomIcon(e,"right",t.right),mapCustomIcon(e,"bottom",t.bottom),mapCustomIcon(e,"left",t.left));return e},beforePatchIcon=t=>{var o,e,i,n,a,c,s;if(null===(o=t.nextState)||void 0===o?void 0:o.has("_icon")){const o=null===(e=t.nextState)||void 0===e?void 0:e.get("_icon"),a=(null===(i=t.nextState)||void 0===i?void 0:i.get("_iconAlign"))||t.state._iconAlign;null===(n=t.nextState)||void 0===n||n.set("_icon",mapIconProp2State(o,a))}else if(null===(a=t.nextState)||void 0===a?void 0:a.has("_iconAlign")){const o=t.state._iconAlign;null===(c=t.nextState)||void 0===c||c.set("_icon",{[o]:void 0,[null===(s=t.nextState)||void 0===s?void 0:s.get("_iconAlign")]:t.state._icon[o]})}},isIcon=t=>"object"==typeof t&&null!==t&&(void 0===t.style||(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.b)(t.style))&&(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t.icon,1),validateIcon=(t,o)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_1__.o)(o,(()=>{try{o=(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_1__.p)(o)}catch(t){}(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_1__.a)(t,"_icon",(t=>null===t||(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t,1)||"object"==typeof t&&null!==t&&((0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t.left,1)||isIcon(t.left)||(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t.right,1)||isIcon(t.right)||(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t.top,1)||isIcon(t.top)||(0,_validator_8ee8737c_js__WEBPACK_IMPORTED_MODULE_0__.a)(t.bottom,1)||isIcon(t.bottom))),new Set(["KoliBriIcon"]),o,{hooks:{beforePatch:(o,e)=>{null===o&&e.set("_icon",{}),beforePatchIcon(t)}},required:!0})}))},watchIconAlign=(t,o)=>{(0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_2__.c)("Das Property _icon-align bzw. _iconAlign ist veraltet. Die Ausrichtung der Icon's kann jetzt direkt über das _icon-Property vorgenommen werden. (v1.1.10: https://public-ui.github.io/?path=/story/backlog-und-changelog--page)"),(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_1__.a)(t,"_iconAlign",(t=>"left"===t||"right"===t),new Set(["Alignment {left, right, top, bottom}"]),o,{hooks:{beforePatch:()=>{beforePatchIcon(t)}}})},options={hooks:{afterPatch:t=>{-1!==t&&0!==t&&(0,_a11y_tipps_d591ee77_js__WEBPACK_IMPORTED_MODULE_2__.e)("Don’t Use Tabindex Greater than 0: https://adrianroselli.com/2014/11/dont-use-tabindex-greater-than-0.html")}}},validateTabIndex=(t,o)=>{(0,_prop_validators_82b345aa_js__WEBPACK_IMPORTED_MODULE_1__.f)(t,"_tabIndex",o,options)};
