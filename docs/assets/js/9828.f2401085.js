...
/* harmony import */ var _controller_icon_e8255fc4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19302);
/*!
 * KoliBri - The accessible HTML-Standard
 */
class InputPasswordController extends _controller_icon_e8255fc4_js__WEBPACK_IMPORTED_MODULE_0__.I{constructor(e,t,a){super(e,t,a),this.handleHiddenLabelAndRequired=()=>{!0===this.component.state._hideLabel&&!0===this.component.state._required?((0,_a11y_tipps_353a7f35_js__WEBPACK_IMPORTED_MODULE_1__.d)("[KolInput*] Wenn man das Label ausblendet, dann kann der sehende Nutzer:in nicht mehr erkennen, ob die Eingabe erforderlich ist."),this.hideLabel=!1):this.hideLabel=!0===this.component.state._hideLabel},this.component=e}validateAutoComplete(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.component,"_autoComplete",(e=>"string"==typeof e&&("on"===e||"off"===e)),new Set(["on | off"]),e)}validateHideLabel(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.component,"_hideLabel",e,{hooks:{afterPatch:this.handleHiddenLabelAndRequired}})}validateMaxLength(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.component,"_maxLength",e,{min:0})}validatePattern(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.w)(this.component,"_pattern",e)}validatePlaceholder(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.w)(this.component,"_placeholder",e)}validateReadOnly(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.component,"_readOnly",e)}validateRequired(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.component,"_required",e,{hooks:{afterPatch:this.handleHiddenLabelAndRequired}})}validateSize(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.component,"_size",e,{min:1})}validateValue(e){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.w)(this.component,"_value",e)}componentWillLoad(){super.componentWillLoad(),this.validateAutoComplete(this.component._autoComplete),this.validateMaxLength(this.component._maxLength),this.validatePattern(this.component._pattern),this.validatePlaceholder(this.component._placeholder),this.validateReadOnly(this.component._readOnly),this.validateRequired(this.component._required),this.validateSize(this.component._size),this.validateValue(this.component._value)}onBlur(e){this.component.state=Object.assign(Object.assign({},this.component.state),{_placeholder:this.placeholderCache}),this.placeholderCache=void 0,super.onBlur(e)}onFocus(e){this.placeholderCache=this.component.state._placeholder,this.component.state=Object.assign(Object.assign({},this.component.state),{_placeholder:void 0}),super.onFocus(e)}}
 ...
 * KoliBri - The accessible HTML-Standard
 */
const searchFormElement=e=>{for((0,_dev_utils_3ec9f837_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&((0,_a11y_tipps_353a7f35_js__WEBPACK_IMPORTED_MODULE_1__.d)("↓ Search form element start."),console.log(e));e instanceof HTMLElement&&"FORM"!==e.tagName&&"KOL-FORM"!==e.tagName;)e=e.parentElement instanceof HTMLElement?e.parentElement:e.parentNode instanceof ShadowRoot?e.parentNode.host:null,(0,_dev_utils_3ec9f837_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&console.log(e);return (0,_dev_utils_3ec9f837_js__WEBPACK_IMPORTED_MODULE_0__.b)()&&(0,_a11y_tipps_353a7f35_js__WEBPACK_IMPORTED_MODULE_1__.d)("↑ Search form element finished."),e},propergateResetEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new Event("reset",{bubbles:!0,cancelable:!0});if("FORM"===t.tagName)(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,t),t.dispatchEvent(e);else if("KOL-FORM"===t.tagName){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.K.querySelector("form",t));const o=t;"object"==typeof o._on&&null!==typeof o._on&&"function"==typeof o._on.onReset&&o._on.onReset(e)}}},propergateSubmitEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new SubmitEvent("submit",{bubbles:!0,cancelable:!0,submitter:t});if("FORM"===t.tagName)(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,t),t.dispatchEvent(e);else if("KOL-FORM"===t.tagName){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.f)(e,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.K.querySelector("form",t));const o=t;"object"==typeof o._on&&null!==typeof o._on&&"function"==typeof o._on.onSubmit&&o._on.onSubmit(e)}}};
...
/* harmony import */ var _controller_7e132b4e_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63228);
/*!
 * KoliBri - The accessible HTML-Standard
 */
class InputTextEmailController extends _controller_7e132b4e_js__WEBPACK_IMPORTED_MODULE_0__.I{constructor(t,o,e){super(t,o,e),this.component=t}validateList(t){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_1__.d)(this.component,"_list",(t=>"string"==typeof t),t)}componentWillLoad(){super.componentWillLoad(),this.validateList(this.component._list)}}class InputTextController extends InputTextEmailController{constructor(t,o,e){super(t,o,e),this.hasError=!1,this.hasList=!1,this.component=t}validateType(t){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_1__.a)(this.component,"_type",(t=>"string"==typeof t&&("text"===t||"search"===t||"url"===t||"tel"===t)),new Set(["String {text, search, url, tel}"]),t)}componentWillLoad(){super.componentWillLoad(),this.validateType(this.component._type)}}
...
/* harmony export */ });
/* harmony import */ var _prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(39895);
/* harmony import */ var _reuse_2b3b6999_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(39519);
/* harmony import */ var _icon_65a5bdd2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(47192);
/* harmony import */ var _controller_cdabc4f0_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(38481);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const beforePatchIcon=(o,t)=>{const n=o;"object"==typeof n&&null!==n&&((0,_reuse_2b3b6999_js__WEBPACK_IMPORTED_MODULE_0__.i)(n.right,1)&&(n.right={icon:n.right}),(0,_reuse_2b3b6999_js__WEBPACK_IMPORTED_MODULE_0__.i)(n.left,1)&&(n.left={icon:n.left}),t.set("_icon",n))};class InputIconController extends _controller_cdabc4f0_js__WEBPACK_IMPORTED_MODULE_1__.I{constructor(o,t,n){super(o,t,n),this.component=o}validateIcon(o){(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.o)(o,(()=>{try{o=(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.p)(o)}catch(o){}(0,_prop_validators_88dff60e_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.component,"_icon",(o=>"object"==typeof o&&null!==o&&((0,_reuse_2b3b6999_js__WEBPACK_IMPORTED_MODULE_0__.i)(o.left,1)||(0,_icon_65a5bdd2_js__WEBPACK_IMPORTED_MODULE_3__.i)(o.left)||(0,_reuse_2b3b6999_js__WEBPACK_IMPORTED_MODULE_0__.i)(o.right,1)||(0,_icon_65a5bdd2_js__WEBPACK_IMPORTED_MODULE_3__.i)(o.right))),new Set(["KoliBriHorizontalIcon"]),o,{hooks:{beforePatch:beforePatchIcon},required:!0})}))}componentWillLoad(){super.componentWillLoad(),this.validateIcon(this.component._icon)}}
