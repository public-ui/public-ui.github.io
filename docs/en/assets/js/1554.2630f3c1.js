...
/* harmony export */ });
/* harmony import */ var _styles_d0b2ab71_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(59100);
...
/* harmony import */ var _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(89252);
/* harmony import */ var _index_892ad7fb_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(48065);
...
const sanitizeText = (txt) => _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(txt, (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addNamespaces = function(namespaces, g, _id, diagObj) {
  ...
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info(namespaces);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info("setNode", node);
  });
};
const addClasses = function(classes, g, _id, diagObj, parent) {
  const keys = Object.keys(classes);
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info(classes);
...
const addNotes = function(notes, g, startEdgeId, classes) {
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.o)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.o)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.k)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing class - ", id);
  const conf2 = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart ?? (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().class;
  const securityLevel = (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info("config:", conf2);
  ...
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.l.info(relations);
  ...
  await (0,_index_892ad7fb_js__WEBPACK_IMPORTED_MODULE_8__.r)(
    element,
    g,
  ...
  _mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_mermaid_306576ad_js__WEBPACK_IMPORTED_MODULE_7__.p)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
