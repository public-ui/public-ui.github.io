...
let vertexCounter = 0;
let config = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)();
let vertices = {};
let edges = [];
let classes = {};
let subGraphs = [];
...
let version;
let funs = [];
const sanitizeText = (txt) => _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, config);
...
const addVertex = function(_id, textObj, type, style, classes2, dir, props = {}) {
  ...
  vertexCounter++;
  if (textObj !== void 0) {
    config = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)();
...
const addSingleLink = function(_start, _end, type) {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 Got edge...", edge);
...
const addLink = function(_start, _end, type) {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("addLink (abc78)", _start, _end, type);
  let i, j;
...
const updateLink = function(positions, style) {
  positions.forEach(function(pos) {
    if (pos === "default") {
      ...
      if (_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.isSubstringInArray("fill", style) === -1) {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().securityLevel !== "loose") {
    return;
  }
...
const setLink = function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    if (vertices[id] !== void 0) {
      vertices[id].link = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const addSubGraph = function(_id, list, _title) {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
...
const flowDb = {
  defaultConfig: () => _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.I.flowchart,
...
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/flowDb-bd9f2a91.js
var flowDb_bd9f2a91 = __webpack_require__(353);
// EXTERNAL MODULE: ./node_modules/.pnpm/dagre-d3-es@7.0.10/node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(42521);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/styles-3bbdb1fe.js + 1 modules
var styles_3bbdb1fe = __webpack_require__(5972);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/flowDiagram-90a5ee23.js
...
const addVertices = function(vert, g, svgId, root, _doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,mermaid_485fd1a4.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    if ((0,mermaid_485fd1a4.m)((0,mermaid_485fd1a4.c)().flowchart.htmlLabels)) {
      const node = {
      ...
      const rows = vertexText.split(mermaid_485fd1a4.e.lineBreakRegex);
      for (const row of rows) {
    ...
    mermaid_485fd1a4.l.warn("Adding node", vertex.id, vertex.domId);
...
const addEdges = function(edges, g, diagObj) {
  ...
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,mermaid_485fd1a4.k)(edges.defaultStyle);
  ...
  edges.forEach(function(edge) {
    ...
    if (edge.style !== void 0) {
      const styles = (0,mermaid_485fd1a4.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    } else {
      switch (edge.stroke) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_485fd1a4.n)(edge.interpolate, src/* curveLinear */.c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_485fd1a4.n)(edges.defaultInterpolate, src/* curveLinear */.c_6);
    } else {
      edgeData.curve = (0,mermaid_485fd1a4.n)(conf.curve, src/* curveLinear */.c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,mermaid_485fd1a4.m)((0,mermaid_485fd1a4.c)().flowchart.htmlLabels)) {
        ...
        edgeData.label = edge.text.replace(mermaid_485fd1a4.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const getClasses = function(text, diagObj) {
  mermaid_485fd1a4.l.info("Extracting classes");
  return diagObj.db.getClasses();
};
const draw = function(text, id, _version, diagObj) {
  mermaid_485fd1a4.l.info("Drawing flowchart");
  const { securityLevel, flowchart: conf2 } = (0,mermaid_485fd1a4.c)();
  let sandboxElement;
  ...
  mermaid_485fd1a4.l.warn("Get vertices", vert);
  ...
  (0,mermaid_485fd1a4.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  const keys = Object.keys(vert);
...
const diagram = {
  parser: flowDb_bd9f2a91.p,
  db: flowDb_bd9f2a91.f,
  renderer: styles_3bbdb1fe.f,
  styles: styles_3bbdb1fe.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    ...
    flowDb_bd9f2a91.f.clear();
    flowDb_bd9f2a91.f.setGen("gen-1");
  }
};
...
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/mermaid-485fd1a4.js
var mermaid_485fd1a4 = __webpack_require__(13525);
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/index-b0b3af87.js
var index_b0b3af87 = __webpack_require__(38429);
// EXTERNAL MODULE: ./node_modules/.pnpm/dagre-d3-es@7.0.10/node_modules/dagre-d3-es/src/dagre-js/label/add-html-label.js
var add_html_label = __webpack_require__(3298);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/styles-3bbdb1fe.js
...
const addVertices = function(vert, g, svgId, root, doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    mermaid_485fd1a4.l.info("vertex", vertex, vertex.labelType);
    ...
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,mermaid_485fd1a4.c)().flowchart.padding
    });
    mermaid_485fd1a4.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText: vertexText,
...
const addEdges = function(edges, g, diagObj) {
  mermaid_485fd1a4.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  ...
  edges.forEach(function(edge) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      mermaid_485fd1a4.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      mermaid_485fd1a4.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    mermaid_485fd1a4.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    const linkNameStart = "LS-" + edge.start;
    const linkNameEnd = "LE-" + edge.end;
...
const draw = async function(text, id, _version, diagObj) {
  ...
  let subG;
  const subGraphs = diagObj.db.getSubGraphs();
  mermaid_485fd1a4.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    mermaid_485fd1a4.l.info("Subgraph - ", subG);
  ...
  const vert = diagObj.db.getVertices();
  const edges = diagObj.db.getEdges();
  mermaid_485fd1a4.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,src/* selectAll */.td_)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      mermaid_485fd1a4.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  const svg = root.select(`[id="${id}"]`);
  const element = root.select("#" + id + " g");
  await (0,index_b0b3af87.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  mermaid_485fd1a4.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,mermaid_485fd1a4.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  diagObj.db.indexNodes("subGraph" + i);
  if (!conf2.htmlLabels) {
    const labels = doc.querySelectorAll('[id="' + id + '"] .edgeLabel .label');
