...
let vertexCounter = 0;
let config = (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.c)();
let vertices = {};
let edges = [];
let classes = {};
let subGraphs = [];
...
let version;
let funs = [];
const sanitizeText = (txt) => _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, config);
...
const addVertex = function(_id, textObj, type, style, classes2, dir, props = {}) {
  ...
  vertexCounter++;
  if (textObj !== void 0) {
    config = (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.c)();
...
const addSingleLink = function(_start, _end, type) {
  ...
  _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 Got edge...", edge);
...
const addLink = function(_start, _end, type) {
  _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.l.info("addLink (abc78)", _start, _end, type);
  let i, j;
...
const updateLink = function(positions, style) {
  positions.forEach(function(pos) {
    if (pos === "default") {
      ...
      if (_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.u.isSubstringInArray("fill", style) === -1) {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if ((0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.c)().securityLevel !== "loose") {
    return;
  }
...
const setLink = function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    if (vertices[id] !== void 0) {
      vertices[id].link = _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const addSubGraph = function(_id, list, _title) {
  ...
  _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
...
const flowDb = {
  parseDirective,
  defaultConfig: () => _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_1__.G.flowchart,
...
/* harmony export */ });
/* harmony import */ var _flowDb_197cd6d1_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(92699);
/* harmony import */ var _styles_aea5c17b_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(79263);
/* harmony import */ var _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1979);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63321);
...
const diagram = {
  parser: _flowDb_197cd6d1_js__WEBPACK_IMPORTED_MODULE_7__.p,
  db: _flowDb_197cd6d1_js__WEBPACK_IMPORTED_MODULE_7__.f,
  renderer: _styles_aea5c17b_js__WEBPACK_IMPORTED_MODULE_8__.f,
  styles: _styles_aea5c17b_js__WEBPACK_IMPORTED_MODULE_8__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_9__.q)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
    _styles_aea5c17b_js__WEBPACK_IMPORTED_MODULE_8__.f.setConf(cnf.flowchart);
    _flowDb_197cd6d1_js__WEBPACK_IMPORTED_MODULE_7__.f.clear();
    _flowDb_197cd6d1_js__WEBPACK_IMPORTED_MODULE_7__.f.setGen("gen-2");
  }
};
...
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/flowDb-197cd6d1.js
var flowDb_197cd6d1 = __webpack_require__(92699);
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/mermaid-ddfd1cde.js
var mermaid_ddfd1cde = __webpack_require__(1979);
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/index-7484f147.js
var index_7484f147 = __webpack_require__(357);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.2.2/node_modules/mermaid/dist/styles-aea5c17b.js
...
const addVertices = function(vert, g, svgId, root, doc, diagObj) {
  ...
  keys.forEach(function(id) {
    ...
    const styles = (0,mermaid_ddfd1cde.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    mermaid_ddfd1cde.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      mermaid_ddfd1cde.l.info("vertex", vertex, vertex.labelType);
    } else {
      if ((0,mermaid_ddfd1cde.n)((0,mermaid_ddfd1cde.c)().flowchart.htmlLabels)) {
        const node = {
        ...
        const rows = vertexText.split(mermaid_ddfd1cde.e.lineBreakRegex);
        for (const row of rows) {
    ...
    g.setNode(vertex.id, {
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,mermaid_ddfd1cde.c)().flowchart.padding
    });
    mermaid_ddfd1cde.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText: vertexText,
...
const addEdges = function(edges, g, diagObj) {
  mermaid_ddfd1cde.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,mermaid_ddfd1cde.k)(edges.defaultStyle);
  ...
  edges.forEach(function(edge) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      mermaid_ddfd1cde.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      mermaid_ddfd1cde.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    mermaid_ddfd1cde.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    ...
    if (edge.style !== void 0) {
      const styles = (0,mermaid_ddfd1cde.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_ddfd1cde.o)(edge.interpolate, src/* curveLinear */.c_6);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_ddfd1cde.o)(edges.defaultInterpolate, src/* curveLinear */.c_6);
    } else {
      edgeData.curve = (0,mermaid_ddfd1cde.o)(conf.curve, src/* curveLinear */.c_6);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
    ...
    edgeData.label = edge.text.replace(mermaid_ddfd1cde.e.lineBreakRegex, "\n");
    if (edge.style === void 0) {
...
const getClasses = function(text, diagObj) {
  mermaid_ddfd1cde.l.info("Extracting classes");
  diagObj.db.clear();
  try {
    diagObj.parse(text);
...
const draw = async function(text, id, _version, diagObj) {
  mermaid_ddfd1cde.l.info("Drawing flowchart");
  diagObj.db.clear();
  flowDb_197cd6d1.f.setGen("gen-2");
  diagObj.parser.parse(text);
  let dir = diagObj.db.getDirection();
  if (dir === void 0) {
    dir = "TD";
  }
  const { securityLevel, flowchart: conf2 } = (0,mermaid_ddfd1cde.c)();
  ...
  mermaid_ddfd1cde.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    mermaid_ddfd1cde.l.info("Subgraph - ", subG);
  ...
  mermaid_ddfd1cde.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,src/* selectAll */.td_)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      mermaid_ddfd1cde.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  await (0,index_7484f147.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  mermaid_ddfd1cde.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,mermaid_ddfd1cde.p)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
