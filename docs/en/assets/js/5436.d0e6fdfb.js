 ...
 * KoliBri - The accessible HTML-Standard
 */
const validateHref=(a,r,t={})=>{(0,_prop_validators_f2b9a155_js__WEBPACK_IMPORTED_MODULE_0__.i)(a,"_href",r,t)};
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/index-360ad69b.js
var index_360ad69b = __webpack_require__(86104);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/i18n-342bc196.js
var i18n_342bc196 = __webpack_require__(9824);
;// CONCATENATED MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/ariaCurrentService-6fe36ebc.js
/*!
 * KoliBri - The accessible HTML-Standard
 */
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/events-29e84d75.js
var events_29e84d75 = __webpack_require__(22004);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/component-names-e522484e.js
var component_names_e522484e = __webpack_require__(60848);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/prop.validators-f2b9a155.js
var prop_validators_f2b9a155 = __webpack_require__(15752);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/href-8b03462b.js
var href_8b03462b = __webpack_require__(21208);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/reuse-b66836de.js
var reuse_b66836de = __webpack_require__(63312);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/access-key-e22ec35a.js
var access_key_e22ec35a = __webpack_require__(7379);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/disabled-7ce039e2.js
var disabled_7ce039e2 = __webpack_require__(47836);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/hide-label-f5e03637.js
var hide_label_f5e03637 = __webpack_require__(17584);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/icons-9784d978.js
var icons_9784d978 = __webpack_require__(19684);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/label-452f8c01.js
var label_452f8c01 = __webpack_require__(25108);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/alternative-button-link-role-435f91d3.js
var alternative_button_link_role_435f91d3 = __webpack_require__(38016);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/tab-index-bffbd9f3.js
var tab_index_bffbd9f3 = __webpack_require__(87424);
// EXTERNAL MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/tooltip-align-676fe651.js
var tooltip_align_676fe651 = __webpack_require__(13716);
;// CONCATENATED MODULE: ./node_modules/.pnpm/@public-ui+components@2.1.2/node_modules/@public-ui/components/dist/esm/kol-link-wc.entry.js
/*!
 * KoliBri - The accessible HTML-Standard
 */
const ariaCurrentValuePropTypeOptions=["date","location","page","step","time","true","false"],validateAriaCurrentValue=(t,e)=>{(0,prop_validators_f2b9a155.w)(t,"_ariaCurrentValue",(t=>"string"==typeof t&&ariaCurrentValuePropTypeOptions.includes(t)),new Set([`AriaCurrentValue {${ariaCurrentValuePropTypeOptions.join(", ")}`]),e,{defaultValue:"page"})},validateDownload=(t,e)=>{(0,prop_validators_f2b9a155.i)(t,"_download",e)},validateLinkCallbacks=(t,e)=>{"object"==typeof e&&"function"==typeof(null==e?void 0:e.onClick)&&(t.state=Object.assign(Object.assign({},t.state),{_on:e}))},validateLinkTarget=(t,e)=>{(0,prop_validators_f2b9a155.i)(t,"_target",e)},KolLinkWc=class{constructor(t){(0,index_360ad69b.r)(this,t),this.catchRef=t=>{this.ref=t,(0,reuse_b66836de.a)(this.host,this.ref)},this.onClick=t=>{var e,a;!0===this.state._disabled?(0,events_29e84d75.p)(t):"function"==typeof(null===(e=this.state._on)||void 0===e?void 0:e.onClick)&&(t.preventDefault(),t.stopPropagation(),(0,prop_validators_f2b9a155.q)(t,this.ref),null===(a=this.state._on)||void 0===a||a.onClick(t,this.state._href))},this.getRenderValues=()=>{const t="string"==typeof this.state._target&&"_self"!==this.state._target,e={href:"string"==typeof this.state._href&&this.state._href.length>0?this.state._href:"javascript:void(0);",target:"string"==typeof this.state._target&&this.state._target.length>0?this.state._target:void 0,rel:t?"noopener":void 0,download:"string"==typeof this.state._download?this.state._download:void 0};return!0!==this.state._hideLabel||this.state._label||(0,prop_validators_f2b9a155.j)("[KolLink] Es muss ein Aria-Label gesetzt werden, wenn _hide-label gesetzt ist."),{isExternal:t,tagAttrs:e}},this._accessKey=void 0,this._ariaCurrentValue=void 0,this._disabled=!1,this._download=void 0,this._hideLabel=!1,this._href=void 0,this._icons=void 0,this._label=void 0,this._on=void 0,this._role=void 0,this._tabIndex=void 0,this._target=void 0,this._tooltipAlign="right",this.state={_ariaCurrentValue:"page",_href:"",_icons:{}}}render(){const{isExternal:t,tagAttrs:e}=this.getRenderValues(),a=(0,reuse_b66836de.s)(this.state._label);return (0,index_360ad69b.h)(index_360ad69b.H,{key:"82f9f5d0f689c25163bd6136ca5c34dcb1fd692b",class:"kol-link-wc"},(0,index_360ad69b.h)("a",Object.assign({key:"b7db13f7744362450d778d707e5540558d997ecb",ref:this.catchRef},e,{accessKey:this.state._accessKey,"aria-current":this.state._ariaCurrent,"aria-disabled":this.state._disabled?"true":void 0,"aria-label":this.state._hideLabel&&"string"==typeof this.state._label?`${this.state._label}${t?` (${(0,i18n_342bc196.t)("kol-open-link-in-tab")})`:""}`:void 0,class:{disabled:!0===this.state._disabled,"external-link":t,"hide-label":!0===this.state._hideLabel}},this.state._on,{onClick:this.onClick,onKeyPress:this.onClick,role:this.state._role,tabIndex:this.state._disabled?-1:this.state._tabIndex}),(0,index_360ad69b.h)(component_names_e522484e.f,{key:"74e96d85bcef160e5cb9c0d5676981b32e5abaaf",_accessKey:this.state._accessKey,_icons:this.state._icons,_hideLabel:this.state._hideLabel,_label:a?"":this.state._label||this.state._href},(0,index_360ad69b.h)("slot",{key:"e6f537ca1733bf45673369cb51f9cd0a5ed8d349",name:"expert",slot:"expert"})),t&&(0,index_360ad69b.h)(component_names_e522484e.g,{key:"b41fee1ddbffadab9c2371ff336fadb3ce7abe74",class:"external-link-icon",_label:this.state._hideLabel?"":(0,i18n_342bc196.t)("kol-open-link-in-tab"),_icons:"codicon codicon-link-external","aria-hidden":this.state._hideLabel})),(0,index_360ad69b.h)(component_names_e522484e.a,{key:"c6e48539bc159d804fd5cff1983a1a652f16a312","aria-hidden":"true",hidden:a||!this.state._hideLabel,_accessKey:this.state._accessKey,_align:this.state._tooltipAlign,_label:this.state._label||this.state._href}))}validateAccessKey(t){(0,access_key_e22ec35a.v)(this,t)}validateAriaCurrentValue(t){validateAriaCurrentValue(this,t)}validateDisabled(t){(0,disabled_7ce039e2.v)(this,t)}validateDownload(t){validateDownload(this,t)}validateHideLabel(t){(0,hide_label_f5e03637.v)(this,t)}validateHref(t){(0,href_8b03462b.v)(this,t,{required:!0})}validateIcons(t){(0,icons_9784d978.v)(this,t)}validateLabel(t){(0,label_452f8c01.a)(this,t)}validateOn(t){validateLinkCallbacks(this,t)}validateRole(t){(0,alternative_button_link_role_435f91d3.v)(this,t)}validateTabIndex(t){(0,tab_index_bffbd9f3.v)(this,t)}validateTarget(t){validateLinkTarget(this,t)}validateTooltipAlign(t){(0,tooltip_align_676fe651.v)(this,t)}componentWillLoad(){this.validateAccessKey(this._accessKey),this.validateAriaCurrentValue(this._ariaCurrentValue),this.validateDisabled(this._disabled),this.validateDownload(this._download),this.validateHideLabel(this._hideLabel),this.validateHref(this._href),this.validateIcons(this._icons),this.validateLabel(this._label),this.validateOn(this._on),this.validateRole(this._role),this.validateTabIndex(this._tabIndex),this.validateTarget(this._target),this.validateTooltipAlign(this._tooltipAlign),this.unsubscribeOnLocationChange=onLocationChange((t=>{this.state._ariaCurrent=t===this.state._href?this.state._ariaCurrentValue:void 0}))}disconnectedCallback(){this.unsubscribeOnLocationChange&&this.unsubscribeOnLocationChange()}get host(){return (0,index_360ad69b.g)(this)}static get watchers(){return{_accessKey:["validateAccessKey"],_ariaCurrentValue:["validateAriaCurrentValue"],_disabled:["validateDisabled"],_download:["validateDownload"],_hideLabel:["validateHideLabel"],_href:["validateHref"],_icons:["validateIcons"],_label:["validateLabel"],_on:["validateOn"],_role:["validateRole"],_tabIndex:["validateTabIndex"],_target:["validateTarget"],_tooltipAlign:["validateTooltipAlign"]}}};
