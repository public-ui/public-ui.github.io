...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(63321);
...
const parseDirective = function(statement, context, type) {
  _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.m.parseDirective(this, statement, context, type);
};
const clear = function() {
  ...
  lastOrder = 0;
  links = {};
  (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.v)();
};
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Invalid date:" + str);
    _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel !== "loose") {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  parseDirective,
  getConfig: () => (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setTodayMarker,
  getTodayMarker,
  setAccTitle: _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.s,
  getAccTitle: _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.g,
  setDiagramTitle: _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.r,
  getDiagramTitle: _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.t,
  setDisplayMode,
  getDisplayMode,
  setAccDescription: _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.b,
  getAccDescription: _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.a,
  addSection,
  getSections,
  getTasks,
  addTask,
...
const setConf = function() {
  _mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Something is calling, setConf, remove the call");
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt;
  ...
  (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.i)(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function(d) {
      const rows = d[0].split(_mermaid_ddfd1cde_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex);
