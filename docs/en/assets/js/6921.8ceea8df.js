...
/* harmony export */ });
/* harmony import */ var _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(83143);
...
/* harmony import */ var _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(13525);
/* harmony import */ var _index_b0b3af87_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(38429);
...
const sanitizeText = (txt) => _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(txt, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addNamespaces = function(namespaces, g, _id, diagObj) {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info(namespaces);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info("setNode", node);
  });
};
const addClasses = function(classes, g, _id, diagObj, parent) {
  const keys = Object.keys(classes);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info(classes);
...
const addNotes = function(notes, g, startEdgeId, classes) {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.n)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.k)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing class - ", id);
  const conf2 = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().flowchart ?? (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().class;
  const securityLevel = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info("config:", conf2);
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.l.info(relations);
  ...
  await (0,_index_b0b3af87_js__WEBPACK_IMPORTED_MODULE_8__.r)(
    element,
    g,
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_7__.o)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
const diagram = {
  parser: _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_9__.p,
  db: _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_9__.d,
  renderer,
  styles: _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_9__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_c47180b5_js__WEBPACK_IMPORTED_MODULE_9__.d.clear();
  }
};
...
// EXTERNAL MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/mermaid-485fd1a4.js
var mermaid_485fd1a4 = __webpack_require__(13525);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/createText-b3507a77.js
...
const createText = (el, text = "", {
  ...
  mermaid_485fd1a4.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,mermaid_485fd1a4.J)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
/* harmony export */ });
/* harmony import */ var _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13525);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56928);
/* harmony import */ var _createText_b3507a77_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(707);
...
const extension = (elem, type, id) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.trace("Making markers for ", id);
...
const createLabel = (_vertexText, style, isTitle, isNode) => {
  ...
  if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)) {
    vertexText = vertexText.replace(/\\n|\n/g, "<br />");
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("vertexText" + vertexText);
    const node = {
      isNode,
      label: (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.J)(vertexText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
        (s) => `<i class='${s.replace(":", " ")}'></i>`
      ),
      labelStyle: style.replace("fill:", "color:")
...
const labelHelper = async (parent, node, _classes, isNode) => {
  let classes;
  const useHtmlLabels = node.useHtmlLabels || (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels);
  if (!_classes) {
  ...
  if (node.labelType === "markdown") {
    text = (0,_createText_b3507a77_js__WEBPACK_IMPORTED_MODULE_2__.c)(label, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.d)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.J)(labelText), (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)()), {
      useHtmlLabels,
      width: node.width || (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.wrappingWidth,
      classes: "markdown-node-label"
    });
  } else {
    text = textNode.appendChild(
      createLabel$1(
        (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.d)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.J)(labelText), (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)()),
        node.labelStyle,
        false,
        isNode
      )
        ...
        [...images].map(
          (img) => new Promise((res) => {
            function setupImage() {
              ...
              if (noImgText) {
                const bodyFontSize = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().fontSize ? (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().fontSize : window.getComputedStyle(document.body).fontSize;
...
const note = async (parent, node) => {
  const useHtmlLabels = node.useHtmlLabels || (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels;
  if (!useHtmlLabels) {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Classes = ", node.classes);
...
const question = async (parent, node) => {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Question main (Circle)");
  const questionElem = insertPolygonShape(shapeSvg, s, s, points);
  questionElem.attr("style", node.style);
  updateNodeBounds(node, questionElem);
  node.intersect = function(point2) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("Intersect called");
...
const rect = async (parent, node) => {
  ...
  if (node.props) {
    ...
    propKeys.forEach((propKey) => {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn(`Unknown node property ${propKey}`);
    });
  }
  updateNodeBounds(node, rect2);
  node.intersect = function(point2) {
...
const labelRect = async (parent, node) => {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.trace("Classes = ", node.class);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const totalWidth = 0;
  const totalHeight = 0;
...
function applyNodePropertyBorders(rect2, borders, totalWidth, totalHeight) {
  ...
  if (borders.includes("t")) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("add top border");
    addBorder(totalWidth);
  } else {
    skipBorder(totalWidth);
  }
  if (borders.includes("r")) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("add right border");
    addBorder(totalHeight);
  } else {
    skipBorder(totalHeight);
  }
  if (borders.includes("b")) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("add bottom border");
    addBorder(totalWidth);
  } else {
    skipBorder(totalWidth);
  }
  if (borders.includes("l")) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("add left border");
    addBorder(totalHeight);
  } else {
    skipBorder(totalHeight);
  }
...
const rectWithTitle = (parent, node) => {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Label text abc79", title, text2, typeof text2 === "object");
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Text 2", text2);
...
const circle = async (parent, node) => {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Circle main");
  updateNodeBounds(node, circle2);
  node.intersect = function(point2) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Circle intersect", node, bbox.width / 2 + halfPadding, point2);
...
const doublecircle = async (parent, node) => {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("DoubleCircle main");
  updateNodeBounds(node, outerCircle);
  node.intersect = function(point2) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("DoubleCircle intersect", node, bbox.width / 2 + halfPadding + gap, point2);
...
const class_box = (parent, node) => {
  ...
  if (node.classData.type !== void 0 && node.classData.type !== "") {
    if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels) {
...
const insertNode = async (elem, node, dir) => {
  ...
  if (node.link) {
    let target;
    if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().securityLevel === "sandbox") {
      target = "_top";
...
const positionNode = (node) => {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.trace(
    "Transforming node",
    node.diff,
    node,
...
const insertEdgeLabel = (elem, edge) => {
  const useHtmlLabels = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels);
  const labelElement = edge.labelType === "markdown" ? (0,_createText_b3507a77_js__WEBPACK_IMPORTED_MODULE_2__.c)(elem, edge.label, {
    style: edge.labelStyle,
    useHtmlLabels,
    addSvgBackground: true
  }) : createLabel$1(edge.label, edge.labelStyle);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc82", edge, edge.labelType);
...
function setTerminalWidth(fo, value) {
  if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels && fo) {
    fo.style.width = value.length * 9 + "px";
    fo.style.height = "12px";
  }
}
const positionEdgeLabel = (edge, paths) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Moving label abc78 ", edge.id, edge.label, edgeLabels[edge.id]);
  ...
  if (edge.label) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.calcLabelPosition(path);
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", "translate(" + x + ", " + y + ")");
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", "translate(" + x + ", " + y + ")");
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", "translate(" + x + ", " + y + ")");
...
const intersection = (node, outsidePoint, insidePoint) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn(`intersection calc abc89:
  ...
  if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
    ...
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn(`abc89 topp/bott calc, Q ${Q}, q ${q}, R ${R}, r ${r}`, res);
    return res;
  } else {
    ...
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, { _x, _y });
    if (r === 0) {
      _x = outsidePoint.x;
      _y = outsidePoint.y;
    }
...
const cutPathAtIntersect = (_points, boundryNode) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("abc88 cutPathAtIntersect", _points, boundryNode);
  let points = [];
  let lastPointOutside = _points[0];
  let isInside = false;
  _points.forEach((point2) => {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc88 checking point", point2, boundryNode);
    if (!outsideNode(boundryNode, point2) && !isInside) {
      const inter = intersection(boundryNode, lastPointOutside, point2);
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("abc88 inside", point2, lastPointOutside, inter);
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("abc88 intersection", inter);
      ...
      if (!points.some((e) => e.x === inter.x && e.y === inter.y)) {
        ...
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("abc88 no intersect", inter, points);
      }
      isInside = true;
    } else {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("abc88 outside", point2, lastPointOutside);
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.warn("abc88 returning points", points);
  return points;
};
const insertEdge = function(elem, e, edge, clusterDb, diagramType, graph, id) {
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc88 InsertEdge: ", edge);
  ...
  if (edge.toCluster) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("to cluster abc88", clusterDb[edge.toCluster]);
    points = cutPathAtIntersect(edge.points, clusterDb[edge.toCluster].node);
    pointsHasChanged = true;
  }
  if (edge.fromCluster) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("from cluster abc88", clusterDb[edge.fromCluster]);
  ...
  let url = "";
  if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.arrowMarkerAbsolute || (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().state.arrowMarkerAbsolute) {
    url = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search;
    url = url.replace(/\(/g, "\\(");
    url = url.replace(/\)/g, "\\)");
  }
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("arrowTypeStart", edge.arrowTypeStart);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.info("arrowTypeEnd", edge.arrowTypeEnd);
...
/* harmony import */ var _edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(47653);
/* harmony import */ var _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13525);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(42521);
/* harmony import */ var _createText_b3507a77_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(707);
...
const isDescendant = (id, ancenstorId) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("In isDecendant", ancenstorId, " ", id, " = ", descendants[ancenstorId].includes(id));
...
const edgeInCluster = (edge, clusterId) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Decendants of ", clusterId, " is ", descendants[clusterId]);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge is ", edge);
  if (edge.v === clusterId) {
    return false;
  }
  if (edge.w === clusterId) {
  ...
  if (!descendants[clusterId]) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Tilt, ", clusterId, ",not in decendants");
    return false;
  }
  return descendants[clusterId].includes(edge.v) || isDescendant(edge.v, clusterId) || isDescendant(edge.w, clusterId) || descendants[clusterId].includes(edge.w);
};
const copy = (clusterId, graph, newGraph, rootId) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
    "Copying children of ",
    clusterId,
    "root",
    rootId,
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Copying (nodes) clusterId", clusterId, "nodes", nodes);
  nodes.forEach((node) => {
    if (graph.children(node).length > 0) {
      copy(node, graph, newGraph, rootId);
    } else {
      const data = graph.node(node);
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("cp ", node, " to ", rootId, " with parent ", clusterId);
      newGraph.setNode(node, data);
      if (rootId !== graph.parent(node)) {
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Setting parent", node, graph.parent(node));
        newGraph.setParent(node, graph.parent(node));
      }
      if (clusterId !== rootId && node !== clusterId) {
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Setting parent", node, clusterId);
        newGraph.setParent(node, clusterId);
      } else {
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("In copy ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(
      ...
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Copying Edges", edges);
      edges.forEach((edge) => {
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge", edge);
        const data2 = graph.edge(edge.v, edge.w, edge.name);
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge data", data2, rootId);
        try {
          if (edgeInCluster(edge, rootId)) {
            _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Copying as ", edge.v, edge.w, data2, edge.name);
            newGraph.setEdge(edge.v, edge.w, data2, edge.name);
            _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("newGraph edges ", newGraph.edges(), newGraph.edge(newGraph.edges()[0]));
          } else {
            _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info(
          ...
          _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.error(e);
        }
      });
    }
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Removing node", node);
...
const findNonClusterChild = (id, graph) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Searching", id);
  const children = graph.children(id);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Searching children of id ", id, children);
  if (children.length < 1) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("This is a valid node", id);
    return id;
  }
  for (const child of children) {
    const _id = findNonClusterChild(child, graph);
    if (_id) {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Found replacement for", id, " => ", _id);
      return _id;
    }
  }
};
...
const adjustClustersAndEdges = (graph, depth) => {
  if (!graph || depth > 10) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Opting out, no graph ");
    return;
  } else {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Opting in, graph ");
  }
  ...
  graph.nodes().forEach(function(id) {
    ...
    if (children.length > 0) {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Cluster identified", id, descendants);
      edges.forEach((edge) => {
        if (edge.v !== id && edge.w !== id) {
          const d1 = isDescendant(edge.v, id);
          const d2 = isDescendant(edge.w, id);
          if (d1 ^ d2) {
            _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Edge: ", edge, " leaves cluster ", id);
            _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Decendants of XXX ", id, ": ", descendants[id]);
            clusterDb[id].externalConnections = true;
          }
        }
      });
    } else {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Not a cluster ", id, descendants);
    }
  });
  graph.edges().forEach(function(e) {
    const edge = graph.edge(e);
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
    let v = e.v;
    let w = e.w;
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
      "Fix XXX",
    ...
    if (clusterDb[e.v] && clusterDb[e.w] && clusterDb[e.v] === clusterDb[e.w]) {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Fixing and trixing link to self - removing XXX", e.v, e.w, e.name);
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Fixing and trixing - removing XXX", e.v, e.w, e.name);
      v = getAnchorId(e.v);
      w = getAnchorId(e.w);
      ...
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Fix Replacing with XXX", v, w, e.name);
      graph.setEdge(v, w, edge, e.name);
    }
  });
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
  extractor(graph, 0);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph), graph.children("D"));
  if (depth > 10) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.error("Bailing out");
    return;
  }
  ...
  if (!hasChildren) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Done, no node has children", graph.nodes());
    return;
  }
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Nodes = ", nodes, depth);
  for (const node of nodes) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(
      "Extracting node",
      node,
    ...
    if (!clusterDb[node]) {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Not a cluster", node, depth);
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      if (clusterDb[node] && clusterDb[node].clusterData && clusterDb[node].clusterData.dir) {
        ...
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Fixing dir", clusterDb[node].clusterData.dir, dir);
      }
      ...
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
      ...
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(clusterGraph));
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
    } else {
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
      ...
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(clusterDb);
    }
  }
  nodes = graph.nodes();
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New list of nodes", nodes);
  for (const node of nodes) {
    const data = graph.node(node);
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(" Now next level", node, data);
    if (data.clusterNode) {
...
const rect = (parent, node) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Creating subgraph rect for ", node.id, node);
  const shapeSvg = parent.insert("g").attr("class", "cluster" + (node.class ? " " + node.class : "")).attr("id", node.id);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const useHtmlLabels = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels);
  const label = shapeSvg.insert("g").attr("class", "cluster-label");
  const text = node.labelType === "markdown" ? (0,_createText_b3507a77_js__WEBPACK_IMPORTED_MODULE_5__.c)(label, node.labelText, { style: node.labelStyle, useHtmlLabels }) : label.node().appendChild((0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.c)(node.labelText, node.labelStyle, void 0, true));
  let bbox = text.getBBox();
  if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels)) {
    const div = text.children[0];
  ...
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Data ", node, JSON.stringify(node));
  ...
  node.intersect = function(point) {
    return (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.i)(node, point);
  };
  return shapeSvg;
};
...
const roundedWithTitle = (parent, node) => {
  ...
  const text = label.node().appendChild((0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.c)(node.labelText, node.labelStyle, void 0, true));
  let bbox = text.getBBox();
  if ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels)) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_3__/* .select */ .Ys)(text);
  ...
  label.attr(
    "transform",
    "translate(" + (node.x - bbox.width / 2) + ", " + (node.y - node.height / 2 - node.padding / 3 + ((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.m)((0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels) ? 5 : 3)) + ")"
  );
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.intersect = function(point) {
...
const insertCluster = (elem, node) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Inserting cluster");
...
const recursiveRender = async (_elem, graph, diagramtype, id, parentCluster) => {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph), parentCluster);
  const dir = graph.graph().rankdir;
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Dir in recursive render - dir:", dir);
  const elem = _elem.insert("g").attr("class", "root");
  if (!graph.nodes()) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("No nodes found for", graph);
  } else {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Recursive render XXX", graph.nodes());
  }
  if (graph.edges().length > 0) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Recursive edges", graph.edge(graph.edges()[0]));
  }
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (parentCluster !== void 0) {
        ...
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Setting data for cluster XXX (", v, ") ", data, parentCluster);
        graph.setNode(parentCluster.id, data);
        if (!graph.parent(v)) {
          _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.trace("Setting parent", v, parentCluster.id);
          graph.setParent(v, parentCluster.id, data);
        }
      }
      _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("(Insert) Node XXX" + v + ": " + JSON.stringify(graph.node(v)));
      if (node && node.clusterNode) {
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Cluster identified", v, node.width, graph.node(v));
        const o = await recursiveRender(nodes, node.graph, diagramtype, id, graph.node(v));
        const newEl = o.elem;
        (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.u)(node, newEl);
        node.diff = o.diff || 0;
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Node bounds (abc123)", v, node, node.width, node.x, node.y);
        (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.s)(newEl, node);
        _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Recursive render complete ", newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Cluster - the non recursive path XXX", v, node.id, node, graph);
          _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info(findNonClusterChild(node.id, graph));
          clusterDb[node.id] = { id: findNonClusterChild(node.id, graph), node };
        } else {
          _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Node - the non recursive path", v, node.id, node);
          await (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.e)(nodes, graph.node(v), dir);
        }
      }
    })
  );
  graph.edges().forEach(function(e) {
    ...
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge " + e.v + " -> " + e.w + ": ", e, " ", JSON.stringify(graph.edge(e)));
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Fix", clusterDb, "ids:", e.v, e.w, "Translateing: ", clusterDb[e.v], clusterDb[e.w]);
    (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.f)(edgeLabels, edge);
  });
  graph.edges().forEach(function(e) {
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
  });
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("#############################################");
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("###                Layout                 ###");
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("#############################################");
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info(graph);
  (0,dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__/* .layout */ .bK)(graph);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph));
  let diff = 0;
  sortNodesByHierarchy(graph).forEach(function(v) {
    const node = graph.node(v);
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Position " + v + ": " + JSON.stringify(graph.node(v)));
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info(
      "Position " + v + ": (" + node.x,
      "," + node.y,
      ") width: ",
    ...
    if (node && node.clusterNode) {
      (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.p)(node);
    } else {
      if (graph.children(v).length > 0) {
  ...
  graph.edges().forEach(function(e) {
    const edge = graph.edge(e);
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(edge), edge);
    const paths = (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.g)(edgePaths, e, edge, clusterDb, diagramtype, graph, id);
    (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.h)(edge, paths);
  });
  graph.nodes().forEach(function(v) {
    const n = graph.node(v);
    _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.info(v, n.type, n.diff);
    if (n.type === "group") {
      diff = n.diff;
    }
  });
...
const render = async (elem, graph, markers, diagramtype, id) => {
  (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.a)(elem, markers, diagramtype, id);
  (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.b)();
  (0,_edges_bc33a094_js__WEBPACK_IMPORTED_MODULE_6__.d)();
  clear();
  clear$1();
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .c(graph)));
...
class ClassMember {
  constructor(input, memberType) {
    ...
    this.visibility = "";
    this.classifier = "";
    const sanitizedInput = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.d)(input, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.v)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.v)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.v)(this.returnType);
      }
    }
...
let functions = [];
const sanitizeText = (txt) => _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)());
const splitClassNameAndType = function(_id) {
  const id = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(_id, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  let genericType = "";
  let className = id;
  if (id.indexOf("~") > 0) {
...
const addClass = function(_id) {
  ...
  const name = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(className, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  classes[name] = {
    id: name,
    type,
    label: name,
...
const clear = function() {
  ...
  namespaces = {};
  namespaceCounter = 0;
  (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.t)();
};
...
const addRelation = function(relation) {
  _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(
    relation.relationTitle1.trim(),
    (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)()
  );
  relation.relationTitle2 = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(
...
const setLink = function(ids, linkStr, target) {
  const config = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (_id[0].match(/\d/)) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (classes[id] !== void 0) {
      classes[id].link = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const setClickFunc = function(_domId, functionName, functionArgs) {
  const domId = _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(_domId, (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)());
  const config = (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)();
    ...
    functions.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.u.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
const db = {
  setAccTitle: _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.s,
  getAccTitle: _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.g,
  getAccDescription: _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.a,
  setAccDescription: _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.b,
  getConfig: () => (0,_mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.c)().class,
  addClass,
  bindFunctions,
  clear,
  getClass,
  ...
  setTooltip,
  lookUpDomId,
  setDiagramTitle: _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.q,
  getDiagramTitle: _mermaid_485fd1a4_js__WEBPACK_IMPORTED_MODULE_1__.r,
  setClassLabel,
  addNamespace,
