...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.5.1/node_modules/mermaid/dist/sankeyDiagram-31fcfff2.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_485fd1a4.e.sanitizeText(ID, (0,mermaid_485fd1a4.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_485fd1a4.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
  findOrCreateNode,
  getAccTitle: mermaid_485fd1a4.g,
  setAccTitle: mermaid_485fd1a4.s,
  getAccDescription: mermaid_485fd1a4.a,
  setAccDescription: mermaid_485fd1a4.b,
  getDiagramTitle: mermaid_485fd1a4.r,
  setDiagramTitle: mermaid_485fd1a4.q,
  clear
};
const _Uid = class {
  static next(name) {
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_485fd1a4.c)();
  const defaultSankeyConfig = mermaid_485fd1a4.I.sankey;
  let sandboxElement;
  ...
  (0,mermaid_485fd1a4.i)(svg, height, width, useMaxWidth);
