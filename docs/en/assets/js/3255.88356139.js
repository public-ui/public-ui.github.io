...
;// CONCATENATED MODULE: ./node_modules/.pnpm/mermaid@10.3.0/node_modules/mermaid/dist/sankeyDiagram-e679478d.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_a98f434b.e.sanitizeText(ID, (0,mermaid_a98f434b.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_a98f434b.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
  findOrCreateNode,
  getAccTitle: mermaid_a98f434b.g,
  setAccTitle: mermaid_a98f434b.s,
  getAccDescription: mermaid_a98f434b.a,
  setAccDescription: mermaid_a98f434b.b,
  getDiagramTitle: mermaid_a98f434b.t,
  setDiagramTitle: mermaid_a98f434b.r,
  clear
};
const _Uid = class {
  static next(name) {
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_a98f434b.c)();
  const defaultSankeyConfig = mermaid_a98f434b.G.sankey;
  let sandboxElement;
  ...
  (0,mermaid_a98f434b.i)(svg, height, width, useMaxWidth);
