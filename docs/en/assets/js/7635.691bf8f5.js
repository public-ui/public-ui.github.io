 ...
 * KoliBri - The accessible HTML-Standard
 */
const validateImageSource=(a,r,t)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.i)(a,"_src",r,t)};
...
/* harmony import */ var _i18n_59fb5a46_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98852);
/* harmony import */ var _image_source_d770a708_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24400);
/* harmony import */ var _label_20475610_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(97876);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const formatNameAsInitial=a=>0===a.length?"":a[0].toUpperCase(),formatLabelAsInitials=a=>{const t=a.split(/\s+/),e=t.at(0),s=t.at(-1);return t.length>=2&&e&&s?`${formatNameAsInitial(e)}${formatNameAsInitial(s)}`:formatNameAsInitial(a)},KolAvatarWc=class{constructor(a){(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_0__.r)(this,a),this._src=void 0,this._label=void 0,this.state={_src:"",_label:""}}render(){return (0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_0__.H,{key:"672b71c600e54214bbaf86210fe439af3f187c83",class:"kol-avatar-wc"},(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div",{key:"8631bb174ac54c1677149d12979f6837dddd692d","aria-label":(0,_i18n_59fb5a46_js__WEBPACK_IMPORTED_MODULE_1__.t)("kol-avatar-alt",{placeholders:{name:this.state._label}}),class:"container",role:"img"},this.state._src?(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_0__.h)("img",{alt:"","aria-hidden":"true",class:"image",src:this.state._src}):(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_0__.h)("span",{"aria-hidden":"true",class:"initials"},formatLabelAsInitials(this.state._label.trim()))))}validateSrc(a){(0,_image_source_d770a708_js__WEBPACK_IMPORTED_MODULE_2__.v)(this,a)}validateLabel(a){(0,_label_20475610_js__WEBPACK_IMPORTED_MODULE_3__.v)(this,a,{required:!0})}componentWillLoad(){this.validateSrc(this._src),this.validateLabel(this._label)}static get watchers(){return{_src:["validateSrc"],_label:["validateLabel"]}}};
