...
/* harmony export */ });
/* harmony import */ var _dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20444);
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(70728);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const validateName=(t,e,i)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.i)(t,"_name",e,i)},isAssociatedTagName=t=>"KOL-BUTTON"===t||"KOL-COMBOBOX"===t||"KOL-INPUT-CHECKBOX"===t||"KOL-INPUT-COLOR"===t||"KOL-INPUT-DATE"===t||"KOL-INPUT-EMAIL"===t||"KOL-INPUT-FILE"===t||"KOL-INPUT-NUMBER"===t||"KOL-INPUT-PASSWORD"===t||"KOL-INPUT-RADIO"===t||"KOL-INPUT-RANGE"===t||"KOL-INPUT-TEXT"===t||"KOL-SELECT"===t||"KOL-TEXTAREA"===t;class AssociatedInputController{constructor(t,e,i){var s,o,a;if(this.experimentalMode=(0,_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_1__.a)(),this.setFormAssociatedValue=t=>{var e;const i=null===(e=this.formAssociated)||void 0===e?void 0:e.getAttribute("name");null!==i&&""!==i||(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.j)(` The form field (${this.type}) must have a name attribute to be form-associated. Please define the _name attribute.`);const s=this.tryToStringifyValue(t);this.syncValue(t,s,this.formAssociated),this.syncValue(t,s,this.syncToOwnInput)},this.component=t,this.host=this.findHostWithShadowRoot(i),this.type=e,this.experimentalMode&&isAssociatedTagName(null===(s=this.host)||void 0===s?void 0:s.tagName)){switch(null===(o=this.host)||void 0===o||o.querySelectorAll("input,select,textarea").forEach((t=>{var e;null===(e=this.host)||void 0===e||e.removeChild(t)})),this.type){case"button":case"color":case"date":case"email":case"file":case"number":case"password":case"radio":case"range":case"text":this.formAssociated=document.createElement("input"),this.formAssociated.setAttribute("type",this.type);break;case"select":this.formAssociated=document.createElement("select"),this.formAssociated.setAttribute("multiple","");break;case"textarea":this.formAssociated=document.createElement("textarea");break;default:this.formAssociated=document.createElement("input"),this.formAssociated.setAttribute("type","hidden")}this.formAssociated.setAttribute("aria-hidden","true"),this.formAssociated.setAttribute("data-form-associated",""),this.formAssociated.setAttribute("hidden",""),null===(a=this.host)||void 0===a||a.appendChild(this.formAssociated)}}findHostWithShadowRoot(t){for(;null===(null==t?void 0:t.shadowRoot)&&t!==document.body;)(t=null==t?void 0:t.parentNode).host&&(t=t.host);return t}setAttribute(t,e,i){if(this.experimentalMode)try{if("boolean"!=typeof(i="object"==typeof i&&null!==i?JSON.stringify(i):i)&&"number"!=typeof i&&"string"!=typeof i)throw new Error("Invalid value type: "+typeof i);null==e||e.setAttribute(t,`${i}`)}catch(i){null==e||e.removeAttribute(t)}}tryToStringifyValue(t){try{return"object"==typeof t&&null!==t?JSON.stringify(t).toString():null==t?null:t.toString()}catch(t){return (0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.l)(`The form field raw value is not able to stringify! ${t}`),""}}syncValue(t,e,i){if(i)switch(this.type){case"file":i.files=t;break;case"select":i.querySelectorAll("option").forEach((t=>{i.removeChild(t)})),Array.isArray(t)&&t.forEach((t=>{const e=this.tryToStringifyValue(t);if("string"==typeof e){const t=document.createElement("option");t.setAttribute("value",e),t.setAttribute("selected",""),i.appendChild(t)}}));break;case"radio":"string"==typeof e&&(i.setAttribute("value",e),i.setAttribute("checked",""),i.value=e);break;default:"string"==typeof e?(i.setAttribute("value",e),i.value=e):(i.removeAttribute("value"),i.value="")}}validateName(t){validateName(this.component,t,{hooks:{afterPatch:()=>{this.setAttribute("name",this.formAssociated,this.component.state._name)}}}),void 0===t&&(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.j)("A name on input fields or switches is not strictly required, but it might be relevant for the autocomplete function and for the static submission of the input field.")}validateSyncValueBySelector(t){if(this.experimentalMode&&"string"==typeof t){const e=document.querySelector(t);e&&(this.syncToOwnInput=e)}}componentWillLoad(){this.validateName(this.component._name),this.validateSyncValueBySelector(this.component._syncValueBySelector)}}
...
/* harmony export */ });
/* harmony import */ var _component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63792);
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70728);
/* harmony import */ var _dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20444);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const searchFormElement=e=>{for((0,_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_0__.a)()&&((0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.j)("↓ Search form element start."),_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_0__.L.debug(e));e instanceof HTMLElement&&"FORM"!==e.tagName&&e.tagName!==_component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_2__.m.toUpperCase();){try{e=e.parentElement instanceof HTMLElement?e.parentElement:e.parentNode instanceof ShadowRoot?e.parentNode.host:null}catch(e){}(0,_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_0__.a)()&&(_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_0__.L.debug(e),(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.j)("↑ Search form element finished."))}return e},propagateResetEventToForm=(e={})=>{var t,o;const n=searchFormElement(e.form);if(n instanceof HTMLElement){const e=new Event("reset",{bubbles:!0,cancelable:!0});if("FORM"===n.tagName)(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.q)(e,n),n.dispatchEvent(e);else if(n.tagName===_component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_2__.m.toUpperCase()){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.q)(e,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.K.querySelector("form",n));const a=n;"function"==typeof(null===(t=a._on)||void 0===t?void 0:t.onReset)&&(null===(o=a._on)||void 0===o||o.onReset(e))}}},propagateSubmitEventToForm=(e={})=>{const t=searchFormElement(e.form);if(t instanceof HTMLElement){const e=new SubmitEvent("submit",{bubbles:!0,cancelable:!0,submitter:t});if("FORM"===t.tagName)(0,_dev_utils_1ca991a2_js__WEBPACK_IMPORTED_MODULE_0__.a)()&&!1===t.noValidate&&(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.j)("If you have not focusable or hidden form fields in your form, you should enable noValidate for your form.",{force:!0}),setTimeout((()=>{"function"==typeof t.requestSubmit?t.requestSubmit():((0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.q)(e,t),t.dispatchEvent(e))}));else if(t.tagName===_component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_2__.m.toUpperCase()){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.q)(e,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__.K.querySelector("form",t));const o=t;setTimeout((()=>{var t,n;"function"==typeof(null===(t=o._on)||void 0===t?void 0:t.onSubmit)&&(null===(n=o._on)||void 0===n||n.onSubmit(e))}))}}};
 ...
 * KoliBri - The accessible HTML-Standard
 */
const validateCustomClass=(a,s)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.i)(a,"_customClass",s,{defaultValue:void 0})};
...
/* harmony export */ });
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70728);
/* harmony import */ var _reuse_108ee8f5_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28968);
/*!
 * KoliBri - The accessible HTML-Standard
 */
...
/* harmony export */ });
/* harmony import */ var _index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65224);
/* harmony import */ var _events_29e84d75_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(29140);
/* harmony import */ var _controller_b8b885e1_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(81821);
/* harmony import */ var _associated_controller_ebcb5051_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(87961);
/* harmony import */ var _component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(63792);
/* harmony import */ var _prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(70728);
/* harmony import */ var _access_key_08edd3a7_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(14724);
/* harmony import */ var _aria_expanded_172cb88c_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(71104);
/* harmony import */ var _icons_05788852_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(84164);
/* harmony import */ var _reuse_108ee8f5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28968);
/* harmony import */ var _custom_class_8e412ac4_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(72824);
/* harmony import */ var _disabled_ecc9abfc_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(11816);
/* harmony import */ var _hide_label_e6a77887_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(12456);
/* harmony import */ var _label_20475610_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(97876);
/* harmony import */ var _tab_index_48c227c3_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(39680);
/* harmony import */ var _tooltip_align_6e87b293_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(51592);
/*!
 * KoliBri - The accessible HTML-Standard
 */
const validateAriaControls=(t,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.i)(t,"_ariaControls",a)},validateAriaSelected=(t,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.b)(t,"_ariaSelected",a)},validateButtonCallbacks=(t,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.w)(t,"_on",(t=>"object"==typeof t&&null!==t),new Set(["ButtonCallbacksPropType {Events.onClick, Events.onMouseDown}"]),a)},buttonTypePropTypeOptions=["button","reset","submit"],validateButtonType=(t,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.w)(t,"_type",(t=>"string"==typeof t&&buttonTypePropTypeOptions.includes(t)),new Set([`KoliBriButtonType {${buttonTypePropTypeOptions.join(", ")}`]),a)},buttonVariantPropTypeOptions=["primary","secondary","normal","tertiary","danger","ghost","custom"],validateButtonVariant=(t,a)=>{(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.w)(t,"_variant",(t=>"string"==typeof t&&buttonVariantPropTypeOptions.includes(t)),new Set([`KoliBriButtonVariant {${buttonVariantPropTypeOptions.join(", ")}`]),a,{defaultValue:"normal"})},KolButtonWc=class{async kolFocus(){var t;null===(t=this.buttonRef)||void 0===t||t.focus()}render(){const t=(0,_reuse_108ee8f5_js__WEBPACK_IMPORTED_MODULE_1__.s)(this.state._label);return (0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.h)(_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.H,{key:"72f9865e9a27e0f31ff94af66f69ab31adc22dd9",class:"kol-button-wc"},(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.h)("button",Object.assign({key:"88b2d8ed077934acfb1707a7e0c71fc9af4789e1",ref:this.catchRef,accessKey:this.state._accessKey||void 0,"aria-controls":this.state._ariaControls,"aria-expanded":(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.x)(this.state._ariaExpanded),"aria-label":this.state._hideLabel&&"string"==typeof this.state._label?this.state._label:void 0,"aria-selected":(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.y)(this.state._ariaSelected),class:{button:!0,disabled:!0===this.state._disabled,[this.state._variant]:"custom"!==this.state._variant,[this.state._customClass]:"custom"===this.state._variant&&"string"==typeof this.state._customClass&&this.state._customClass.length>0,"hide-label":!0===this.state._hideLabel},disabled:this.state._disabled,id:this.state._id,name:this.state._name},this.state._on,{onClick:this.onClick,role:this.state._role,tabIndex:this.state._tabIndex,type:this.state._type}),(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.h)(_component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_3__.f,{key:"425a6e12a5197db406790410cf382bdf6f3df274",class:"button-inner",_accessKey:this.state._accessKey,_icons:this.state._icons,_hideLabel:this.state._hideLabel,_label:t?"":this.state._label},(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.h)("slot",{key:"a70bb86e9824393e81aaddd59fa1fe6f0ef180e3",name:"expert",slot:"expert"}))),(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.h)(_component_names_5dd1e02a_js__WEBPACK_IMPORTED_MODULE_3__.a,{key:"6f8bc766511dd57a8b9189b1b083e12f43262a32","aria-hidden":"true",hidden:t||!this.state._hideLabel,_accessKey:this._accessKey,_align:this.state._tooltipAlign,_label:"string"==typeof this.state._label?this.state._label:""}))}constructor(t){(0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.r)(this,t),this.catchRef=t=>{this.buttonRef=t},this.onClick=t=>{var a,e;"submit"===this.state._type?(0,_controller_b8b885e1_js__WEBPACK_IMPORTED_MODULE_4__.p)({form:this.host,ref:this.buttonRef}):"reset"===this.state._type?(0,_controller_b8b885e1_js__WEBPACK_IMPORTED_MODULE_4__.a)({form:this.host,ref:this.buttonRef}):((0,_events_29e84d75_js__WEBPACK_IMPORTED_MODULE_5__.s)(t),(0,_events_29e84d75_js__WEBPACK_IMPORTED_MODULE_5__.t)("click",this.host,this.state._value),this.controller.setFormAssociatedValue(this.state._value),"function"==typeof(null===(a=this.state._on)||void 0===a?void 0:a.onClick)&&((0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.q)(t,this.buttonRef),null===(e=this.state._on)||void 0===e||e.onClick(t,this.state._value)))},this._accessKey=void 0,this._ariaControls=void 0,this._ariaExpanded=void 0,this._ariaSelected=void 0,this._customClass=void 0,this._disabled=!1,this._hideLabel=!1,this._icons=void 0,this._id=void 0,this._label=void 0,this._name=void 0,this._on=void 0,this._role=void 0,this._syncValueBySelector=void 0,this._tabIndex=void 0,this._tooltipAlign="top",this._type="button",this._value=void 0,this._variant="normal",this.state={_icons:{},_label:"",_on:{},_type:"button",_variant:"normal"},this.controller=new _associated_controller_ebcb5051_js__WEBPACK_IMPORTED_MODULE_6__.A(this,"button",this.host)}validateAccessKey(t){(0,_access_key_08edd3a7_js__WEBPACK_IMPORTED_MODULE_7__.v)(this,t)}validateAriaControls(t){validateAriaControls(this,t)}validateAriaExpanded(t){(0,_aria_expanded_172cb88c_js__WEBPACK_IMPORTED_MODULE_8__.v)(this,t)}validateAriaSelected(t){validateAriaSelected(this,t)}validateCustomClass(t){(0,_custom_class_8e412ac4_js__WEBPACK_IMPORTED_MODULE_9__.v)(this,t)}validateDisabled(t){(0,_disabled_ecc9abfc_js__WEBPACK_IMPORTED_MODULE_10__.v)(this,t)}validateHideLabel(t){(0,_hide_label_e6a77887_js__WEBPACK_IMPORTED_MODULE_11__.v)(this,t)}validateIcons(t){(0,_icons_05788852_js__WEBPACK_IMPORTED_MODULE_12__.v)(this,t)}validateId(t){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.i)(this,"_id",t)}validateLabel(t){(0,_label_20475610_js__WEBPACK_IMPORTED_MODULE_13__.a)(this,t,{required:!0})}validateName(t){this.controller.validateName(t)}validateOn(t){validateButtonCallbacks(this,t)}validateRole(t){(0,_aria_expanded_172cb88c_js__WEBPACK_IMPORTED_MODULE_8__.a)(this,t)}validateSyncValueBySelector(t){this.controller.validateSyncValueBySelector(t)}validateTabIndex(t){(0,_tab_index_48c227c3_js__WEBPACK_IMPORTED_MODULE_14__.v)(this,t)}validateTooltipAlign(t){(0,_tooltip_align_6e87b293_js__WEBPACK_IMPORTED_MODULE_15__.v)(this,t)}validateType(t){validateButtonType(this,t)}validateValue(t){(0,_prop_validators_db70e3c4_js__WEBPACK_IMPORTED_MODULE_0__.s)(this,"_value",t),this.controller.setFormAssociatedValue(this.state._value)}validateVariant(t){validateButtonVariant(this,t)}componentWillLoad(){this.validateAccessKey(this._accessKey),this.validateAriaControls(this._ariaControls),this.validateAriaExpanded(this._ariaExpanded),this.validateAriaSelected(this._ariaSelected),this.validateCustomClass(this._customClass),this.validateDisabled(this._disabled),this.validateHideLabel(this._hideLabel),this.validateIcons(this._icons),this.validateId(this._id),this.validateLabel(this._label),this.validateName(this._name),this.validateOn(this._on),this.validateRole(this._role),this.validateSyncValueBySelector(this._syncValueBySelector),this.validateTabIndex(this._tabIndex),this.validateTooltipAlign(this._tooltipAlign),this.validateType(this._type),this.validateValue(this._value),this.validateVariant(this._variant)}get host(){return (0,_index_022cbbb8_js__WEBPACK_IMPORTED_MODULE_2__.g)(this)}static get watchers(){return{_accessKey:["validateAccessKey"],_ariaControls:["validateAriaControls"],_ariaExpanded:["validateAriaExpanded"],_ariaSelected:["validateAriaSelected"],_customClass:["validateCustomClass"],_disabled:["validateDisabled"],_hideLabel:["validateHideLabel"],_icons:["validateIcons"],_id:["validateId"],_label:["validateLabel"],_name:["validateName"],_on:["validateOn"],_role:["validateRole"],_syncValueBySelector:["validateSyncValueBySelector"],_tabIndex:["validateTabIndex"],_tooltipAlign:["validateTooltipAlign"],_type:["validateType"],_value:["validateValue"],_variant:["validateVariant"]}}};
...
/* harmony export */ });
/* harmony import */ var _align_6c0a2935_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40168);
/*!
 * KoliBri - The accessible HTML-Standard
 */
