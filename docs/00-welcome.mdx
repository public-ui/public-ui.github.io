...
<p className="col-12">
	...
	></kol-link>
	und der <kol-link _href="https://www.bitvtest.de/bitv_test.html" _target="bitv" _label="BITV"></kol-link> für die
	Barrierefreiheit und als eine Multi-Theming-fähige Präsentationsschicht umgesetzt. Es gibt keinerlei fachlichen Bezug
	und keine Datenübertragungsfunktionalitäten. Damit ist <KoliBri /> für die Realisierung statischer Webseiten als auch
	dynamischer Webanwendungen unterschiedlicher Corporate Designs und Styleguides gleichermaßen wiederverwendbar und
