...
<p>
	...
	<KolAlert _type="info" _variant="card">
		<small>
			...
			Prerenderer notwendig sein werden und wird daher unsererseits als experimentell eingestuft (<KolLink _href="https://web.dev/declarative-shadow-dom/" _target="web.dev" _label={`https://web.dev`} />).
		</small>
	</KolAlert>
</p>
