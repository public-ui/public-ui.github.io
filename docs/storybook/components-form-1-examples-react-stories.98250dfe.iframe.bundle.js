...
)`}},i.parameters)},"./src/components/form/1-examples/arg-types.ts":(c,a,n)=>{n.d(a,{P:()=>e});const e={}},"./src/components/form/1-examples/autogen.configuration.ts":(c,a,n)=>{n.d(a,{E:()=>s});var e=n("./node_modules/@storybook/addon-jest/dist/esm/index.js"),_=n("./node_modules/@public-ui/components/jest-test-results.json"),t=n("./node_modules/@geometricpanda/storybook-addon-badges/storybook-addon-badges.esm.js"),d=n("./src/components/form/1-examples/arg-types.ts");const s={decorators:[(0,e.x)({results:_})],parameters:{badges:[t.NZ.STABLE],jest:["form.e2e.ts","form.spec.ts","form.spec.tsx"],status:{type:"bitv"}},argTypes:d.P}}}]);
