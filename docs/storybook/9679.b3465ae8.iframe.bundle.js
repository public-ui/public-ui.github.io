"use strict";(self.webpackChunk_public_ui_storybook=self.webpackChunk_public_ui_storybook||[]).push([[9679],{"./node_modules/@public-ui/components/dist/esm/a11y.tipps-ff5a1a99.js":(I,j,S)=>{S.d(j,{a:()=>e,b:()=>C,c:()=>c,d:()=>r,e:()=>m,f:()=>l,u:()=>v});var g=S("./node_modules/@public-ui/components/dist/esm/dev.utils-daaf2f39.js");/*!
 * KoliBri - The accessible HTML-Standard
 */const f=new Set,m=h=>{f.has(h)===!1&&(f.add(h),g.L.info(h,{classifier:"\u270Ba11y",overwriteStyle:"; background-color: #09f"}))},z=new Set,C=h=>{z.has(h)===!1&&(z.add(h),g.L.warn(h,{classifier:"\u{1F525}deprecated",forceLog:!0,overwriteStyle:"; background-color: #f00"}))},O=new Set,r=h=>{O.has(h)===!1&&(O.add(h),g.L.debug(h,{classifier:"\u{1F4BB}dev",overwriteStyle:"; background-color: #f09"}))},i=new Set,l=(h,y=!1)=>{i.has(h)===!1&&(i.add(h),h+=y===!0?" \u2705":"",g.L.debug(h,{classifier:"\u{1F31F}feature",overwriteStyle:"; background-color: #309"}))};r("Wir freuen uns \xFCber jedes Feedback, Kommentare, Screenshots oder Demo-Links von einer auf KoliBri-basierenden Anwendung (kolibri@itzbund.de). Vielen Dank!");const p=new Set,w=h=>{p.has(h)===!1&&(p.add(h),Log.debug(h,{classifier:"\u{1F4D1}ui/ux",overwriteStyle:"; background-color: #060;"}))},c=()=>{m(`"Disabled" schr\xE4nkt die Zug\xE4nglichkeit und Sichtbarkeit ein. Wir empfehlen aus Sicht der Barrierefreiheit readonly- statt disabled-Attribut zu verwenden.
...
- https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/Navigation_Role#accessibility_concerns`)},v=(h,y=8)=>{var b;y>7&&(b=`[${h}] Innerhalb von Navigationsstrukturen wird empfohlen nicht mehr als 7 Men\xFCpunkte zu verwenden.

Links:
- https://de.ryte.com/wiki/Millersche_Zahl
- https://de.wikipedia.org/wiki/Millersche_Zahl`,p.has(b)===!1&&(p.add(b),g.L.debug(b,{classifier:"\u{1F4D1}ui/ux",overwriteStyle:"; background-color: #060;"})))}},"./node_modules/@public-ui/components/dist/esm/index.m-86dc8c44.js":(I,j,S)=>{S.d(j,{f:()=>w,s:()=>p});/*!
 * KoliBri - The accessible HTML-Standard
 */var g=.2126,f=.7152,m=.0722,z=1/12.92;function C(c){return Math.pow((c+.055)/1.055,2.4)}function O(c){var e=c[0]/255,v=c[1]/255,h=c[2]/255,y=e<=.03928?e*z:C(e),b=v<=.03928?v*z:C(v),E=h<=.03928?h*z:C(h);return y*g+b*f+E*m}function r(c){var e=255;(c=c.replace(/^#/,"")).length===8&&(e=parseInt(c.slice(6,8),16),c=c.substring(0,6)),c.length===4&&(e=parseInt(c.slice(3,4).repeat(2),16),c=c.substring(0,3)),c.length===3&&(c=c[0]+c[0]+c[1]+c[1]+c[2]+c[2]);var v=parseInt(c,16);return[v>>16,v>>8&255,255&v,e]}function i(c,e){return(Math.max(c,e)+.05)/(Math.min(c,e)+.05)}function l(c,e){return i(O(c),O(e))}function p(c,e){return l(r(c),r(e))}function w(c){return c>=7?"AAA":c>=4.5?"AA":c>=3?"AA Large":"Fail"}},"./node_modules/@public-ui/components/dist/esm/kol-table.entry.js":(I,j,S)=>{S.r(j),S.d(j,{kol_table:()=>O});var g=S("./node_modules/@public-ui/components/dist/esm/index-758cec5f.js"),f=S("./node_modules/@public-ui/components/dist/esm/prop.validators-4cac744a.js");/*!
 * KoliBri - The accessible HTML-Standard
