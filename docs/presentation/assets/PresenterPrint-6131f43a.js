import{f as _,h as d,j as p,ai as h,c as m,aj as u,l as n,ak as t,al as o,y as s,F as f,am as g,an as v,ao as x,n as r,ap as b,aq as k,m as y,ar as N,as as w,_ as P}from"./nav-975004bf.js";import{N as V}from"./NoteViewer-f719a5c5.js";import{u as j}from"./index-2950d8c1.js";const S={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},z={class:"opacity-50"},D=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-gray-400/50 mb-8"},M=_({__name:"PresenterPrint",setup(q){d(p),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
