...
- Die Öffnen-/Schließen-Icons sind links ausgerichtet, um die Bedienbarkeit für Nutzende mit eingeschränktem Sichtfeld zu unterstützen.
...
Accordion ist **nicht geeignet**, wenn:
- Inhalte zwingend gleichzeitig sichtbar sein müssen
- Inhalte miteinander verglichen werden müssen
- Nutzer häufig zwischen Abschnitten wechseln müssen
...
Über `_level` sind die Ebenen `1` bis `6` verfügbar.
