...
<kol-input-text
  _type="text"
  _label="Texteingabe"
  _icons='{"left": "kolicon-chevron-left", "right": {"icon": "kolicon-chevron-right", "style": {"font-size": "200%"}}}'
></kol-input-text>
...
<kol-input-text
  _type="text"
  _label="Mit Button"
  _smart-button='{"_icons": "kolicon-cross", "_hideLabel": true, "_label": "Löschen"}'
></kol-input-text>
```
...
<kol-input-text _type="text" _label="Texteingabe" _icons='{"left": "kolicon-chevron-left", "right": {"icon": "kolicon-chevron-right", "style": {"font-size": "200%"}}}'></kol-input-text>
<kol-input-text _type="text" _label="Deaktiviert" _disabled></kol-input-text>
<kol-input-text _type="text" _label="Schreibgeschützt" _read-only></kol-input-text>
<kol-input-text
  _type="text"
  _label="Mit Button"
  _smart-button='{"_icons": "kolicon-cross", "_hideLabel": true, "_label": "Löschen"}'></kol-input-text>
