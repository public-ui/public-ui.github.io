...
- Verstecken Sie Beschriftungen nur, wenn dies aus gestalterischen Gründen erforderlich ist. Auch bei ausgeblendeten Labels sollte die Funktion der Checkbox eindeutig erkennbar bleiben.
- Verwenden Sie den Indeterminate-Zustand ausschließlich zur Darstellung einer teilweisen Auswahl.
- Prüfen Sie bei umfangreichen Auswahllisten, ob eine andere Eingabekomponente, beispielsweise **Select** oder **Combobox**, besser geeignet ist.
...
- Auswahl mehrerer Interessen oder Kategorien
- Mehrfachauswahl aus einer Liste von Optionen
- Aktivieren oder Deaktivieren einzelner Einstellungen oder Funktionen
- Auswahl mehrerer Filteroptionen
