...
<InputCheckboxPreview context="example" initialProps={{ _label: 'Akzeptiere die Bedingungen' }} />
...
<InputCheckboxPreview context="feature" initialProps={{ _label: 'Zustimmen' }} visibleProperties={[]} />

#### Varianten

Die Checkbox unterstützt drei verschiedene visuelle Varianten über das Attribut `_variant`:

<InputCheckboxPreview context="feature" initialProps={{ _label: 'Checkbox-Typ' }} visibleProperties={['_variant']} />
