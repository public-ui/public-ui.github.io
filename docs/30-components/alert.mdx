...
<AlertPreview context="example" initialProps={{ _label: 'Hinweis', _type: 'info', _variant: 'msg' }} />
...
<AlertPreview context="feature" visibleProperties={['_type']} initialProps={{ _label: 'Hinweis', _type: 'info' }} />
...
<AlertPreview context="feature" visibleProperties={['_slot']} initialProps={{ _label: 'Hinweis', _type: 'info' }} />
