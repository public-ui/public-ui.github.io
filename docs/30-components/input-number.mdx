...
* <LabelNote />
* <ErrorMessageNote />
* Das native Input wurde mit zwei Buttons für Wert erhöhen und verringern mit der Barrierefreiheit entsprechenden Größe ergänzt, um die Zugänglichkeit zu verbessern.
