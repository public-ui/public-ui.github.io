...
- Das Eingabefeld muss mit einer aussagekräftigen Beschriftung versehen werden. Es kann visuell ausgeblendet werden, bleibt aber für assistive Technologien verfügbar.
