...
<ImagePreview context="playground" />
...
<ImagePreview context="feature" visibleProperties={['_src']} initialProps={{ _src: '/assets/sample-image.png' }} />
...
<ImagePreview context="feature" visibleProperties={['_alt']} initialProps={{ _alt: 'Beispielbildbeschreibung' }} />
...
Achtung: der Browser wechselt das Bild nur von kleiner zu größer und nicht wieder zurück!
...
<ImagePreview context="feature" visibleProperties={['_loading']} initialProps={{ _loading: 'lazy' }} />
