...
- **Tree in Kontext nutzen**: Tree und Tree-Item sind nur zusammen sinnvoll. Nutzen Sie die <kol-link _href="../components/tree" _label="Tree-Komponente</kol-link> als Wrapper.
