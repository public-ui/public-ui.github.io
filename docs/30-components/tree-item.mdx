...
Tree-Items sind Links und können durch Nutzerinnen und Nutzer aktiviert werden. Das primäre Event ist `click`, das ausgelöst wird, wenn das Tree-Item aktiviert wird:
