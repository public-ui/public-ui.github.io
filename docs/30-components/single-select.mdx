...
- Setzen Sie deaktivierte Optionen nur sparsam ein und erläutern Sie – falls für das Verständnis nötig – über `_hint`, warum eine Option nicht verfügbar ist.
- Bei vielen Optionen (mehr als 15) erwägen Sie eine andere Komponente wie eine Tabelle oder [Combobox](../components/combobox).
