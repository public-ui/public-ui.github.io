...
<LinkButtonPreview context="example" initialProps={{ _label: 'LinkButton' }} />
...
<LinkButtonPreview context="playground" initialProps={{ _label: 'LinkButton' }} />
