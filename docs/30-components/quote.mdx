...
<QuotePreview context="example" initialProps={{ _variant: 'block' }} />
...
<QuotePreview context="playground" />
...
<QuotePreview context="feature" visibleProperties={['_variant']} initialProps={{ _variant: 'inline' }} />
