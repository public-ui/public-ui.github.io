...
<FormPreview context="example" initialProps={{ _requiredText: true }} />
...
<FormPreview context="playground" />
...
<FormPreview context="feature" visibleProperties={['_requiredText']} initialProps={{ _requiredText: true }} />
