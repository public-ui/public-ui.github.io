...
import Readme from '@site/readmes/tree/readme.md';
...
<TreePreview context="playground" />
...
<TreePreview context="feature" visibleProperties={['_label']} />
...
Am `KolTreeItem` wird mit dem Attribut `_open` gesteuert, ob ein Element beim initialen Laden geöffnet ist und mit dem Attribut `_active`, ob ein Element markiert ist (z.B. die aktuelle Seite in einer Navigation).

<TreePreview context="feature" visibleProperties={['_items']} />
