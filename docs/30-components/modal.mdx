...
import Readme from '@site/readmes/modal/readme.md';
...
<ModalPreview context="playground" />
...
<ModalPreview context="feature" visibleProperties={['_label', '_slot']} />
...
<ModalPreview context="feature" visibleProperties={['_width']} initialProps={{ _width: '500px' }} />

#### Varianten

Das Attribut `_variant` definiert die Variante des Modals (`blank` oder `card`).

<ModalPreview context="feature" visibleProperties={['_variant']} initialProps={{ _variant: 'card' }} />
