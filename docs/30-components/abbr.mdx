...
<AbbrPreview context="example" initialProps={{ _label: "zum Beispiel", _slot: "z. B." }} />
...
<AbbrPreview context="playground" />
...
<AbbrPreview context="feature" visibleProperties={['_slot']} initialProps={{ _slot: "z. B." }} />
