...
<DetailsPreview context="example" initialProps={{ _label: 'Weitere Informationen' }} />
...
<DetailsPreview context="feature" visibleProperties={['_label']} initialProps={{ _label: 'Details anzeigen' }} />
