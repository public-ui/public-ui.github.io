...
<AvatarPreview context="example" initialProps={{ _label: 'Max Mustermann' }} />
...
<AvatarPreview context="playground" initialProps={{ _label: 'Max Mustermann', _color: '#5A5FEE' }} />
...
<AvatarPreview context="feature" visibleProperties={['_label']} initialProps={{ _label: 'Anna Schmidt' }} />
