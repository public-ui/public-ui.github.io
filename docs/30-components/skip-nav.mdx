...
import Readme from '@site/readmes/skip-nav/readme.md';
...
<SkipNavPreview context="example" />
...
<SkipNavPreview context="playground" />
...
<SkipNavPreview context="feature" visibleProperties={['_label', '_links']} />
