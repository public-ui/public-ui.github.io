...
- Deaktivieren Sie einzelne Optionen nur, wenn sie tatsächlich nicht verfügbar sind, und erläutern Sie den Grund möglichst im sichtbaren Kontext. Andernfalls blenden Sie nicht verfügbare Optionen besser aus. Für dynamische Filterung verwenden Sie statt deaktivierter Radio-Elemente die <kol-link _href="../components/combobox" _label="Combobox"></kol-link> oder andere Komponenten.
