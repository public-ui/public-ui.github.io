...
- Achten Sie darauf, dass `_name` und `_id` gesetzt sind, damit die Daten beim Formularversand mitgesendet werden.
...
<InputRangePreview
	...
	initialProps={{ _label: 'Lautstärke', _hint: 'Schiebереgler um die Lautstärke zu regulieren (0-100%)' }}
	codeCollapsable
	codeCollapsed
/>
