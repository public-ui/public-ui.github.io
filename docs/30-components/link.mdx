...
Dabei wird der `navigate`-Hook aus React Router im Handler aufgerufen:
...
Damit lassen sich `kol-link`-Komponenten nahtlos in eine React Router Navigation integrieren.
