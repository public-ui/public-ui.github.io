...
**Hinweis:** In der aktuellen Version werden die Vorschlagswerte bei InputColor nicht angezeigt, da die zugehörige Vorschlagsliste nicht erzeugt wird (siehe <kol-link _href="https://github.com/public-ui/kolibri/issues/10859" _target="_blank" _label="#10859"></kol-link>). Das Beispiel zeigt die Konfiguration; die Vorschläge erscheinen erst nach Behebung des Fehlers.
...
<InputColorPreview
	...
	initialProps={{
		_label: 'Markenfarbe',
		_suggestions: ['#005ea8', '#e30613', '#ffcc00'],
	}}
/>
