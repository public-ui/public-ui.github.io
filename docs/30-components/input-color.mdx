...
**Hinweis:** `_suggestions` wird in der API zwar aufgeführt, das zugehörige `datalist`-Element wird derzeit jedoch nicht gerendert. Vorschlagswerte stehen daher nicht zur Verfügung (siehe <kol-link _href="https://github.com/public-ui/kolibri/issues/10859" _target="_blank" _label="#10859"></kol-link>).
