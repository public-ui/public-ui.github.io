...
<VersionPreview context="example" initialProps={{ _label: '1.2.3' }} />
...
<VersionPreview context="playground" />
...
<VersionPreview context="feature" visibleProperties={['_label']} initialProps={{ _label: '2.0.0' }} />
