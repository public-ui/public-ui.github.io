...
<TableStatefulPreview context="example" initialProps={{}} />
...
<TableStatefulPreview context="playground" />
...
<TableStatefulPreview context="feature" visibleProperties={['_label']} initialProps={{}} />
...
<TableStatefulPreview context="feature" visibleProperties={['_headers']} initialProps={{}} />
...
<TableStatefulPreview context="feature" visibleProperties={['_headers', '_allowMultiSort']} initialProps={{}} />

**Erklärung zur compareFn:**
Stencil gibt die zu vergleichenden Objekte nicht mit ihrem Ursprünglichen Type (hier PlantRecord) zurück. Deswegen muss für eine saubere Typisierung der Umweg über unknown gegangen werden:
```jsx
...
<TableStatefulPreview context="feature" visibleProperties={['_paginationPosition']} initialProps={{}} />

**Konfigurierbare Optionen:**
Siehe <kol-link _href="../pagination" _label="Pagination-Komponente"></kol-link>
...
<TableStatefulPreview context="feature" visibleProperties={['_selection']} initialProps={{}} />
...
- `disabledKeys`: Deaktivierte Zeilenidentifizierer
...
<TableStatefulPreview context="feature" visibleProperties={['_hasSettingsMenu']} initialProps={{}} />

#### Fixierte Spalten

Das Attribut `_fixedCols` definiert Spalten, die beim horizontalen Scrollen sichtbar bleiben – Angabe als `[start, end]`:

<TableStatefulPreview context="feature" visibleProperties={[]} initialProps={{}} />

#### Beschriftung über externe Elemente (aria-labelledby)

Mittels `_ariaLabelledby` kann die Tabelle barrierefrei über ein externes Element (z. B. einer vorangestellten Überschrift) beschriftet werden. Das Attribut `_label` sollte dennoch gesetzt werden, da es als Fallback dient, falls die externe Referenz nicht aufgelöst werden kann.

<TableStatefulPreview context="feature" visibleProperties={['_ariaLabelledby']} initialProps={{ _ariaLabelledby: 'table-stateful-heading' }} />
