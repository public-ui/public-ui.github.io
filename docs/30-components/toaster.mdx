...
<kol-alert _label="Toaster werden mit Version 5 entfernt" _level="1" _type="error">
	...
	Statt noch mehr Ressourcen in ein wahrscheinlich nie barrierefreies Konzept zu investieren, möchten wir die Energie in die Entwicklung und Dokumentation robuster, barrierefreier Alternativen lenken.
	Siehe dazu auch [die Diskussion in unserem Github #8372](https://github.com/public-ui/kolibri/issues/8372)
