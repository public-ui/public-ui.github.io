...
* Die Textarea bietet klare Fokusindikatoren.
...
- **Höhe sinnvoll wählen:** Beginnen Sie mit wenigen Zeilen (z. B. `_rows` mit dem Wert `4`) und erlauben Sie bei Bedarf die Größenanpassung über `_resize` oder die automatische Höhenanpassung über `_adjustHeight`, aber vermeiden Sie horizontales Scrollen.
