...
<TextAreaPreview context="feature" initialProps={{ _label: 'Beschreibung' }} visibleProperties={[]} />
...
<TextAreaPreview
	context="feature"
	visibleProperties={['_label', '_msg', '_hint', '_disabled', '_readOnly', '_required', '_hideLabel']}
...
<TextAreaPreview
	...
	initialProps={{ _label: 'Beschreibung', _readOnly: true, _value: 'Dies ist ein nur lesbarer Textbereich.' }}
/>
...
<TextAreaPreview context="feature" visibleProperties={['_rows']} initialProps={{ _label: 'Beschreibung', _rows: 6 }} />
