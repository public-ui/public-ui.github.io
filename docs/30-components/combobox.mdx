...
<ComboboxPreview visibleProperties={['_label']} codeCollapsable codeCollapsed />
...
<ComboboxPreview visibleProperties={['_disabled', '_required', '_touched']} codeCollapsable codeCollapsed />
...
<ComboboxPreview visibleProperties={['_hideLabel']} initialProps={{ _hideLabel: true }} codeCollapsable codeCollapsed />
