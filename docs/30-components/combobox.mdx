...
<ComboboxPreview visibleProperties={['_label']} sourceCodeDetailsCollapsed />
...
<ComboboxPreview visibleProperties={['_disabled', '_required', '_touched']} sourceCodeDetailsCollapsed />
...
<ComboboxPreview
	...
	initialProps={{ _icons: 'kolicon-cogwheel' }}
	sourceCodeDetailsCollapsed
/>
...
<ComboboxPreview
	...
	initialProps={{ _hasClearButton: true }}
	sourceCodeDetailsCollapsed
/>
...
<ComboboxPreview visibleProperties={['_hideLabel']} initialProps={{ _hideLabel: true }} sourceCodeDetailsCollapsed />
