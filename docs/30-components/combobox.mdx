...
- Die Combobox benötigt einen zugänglichen Namen. Dieser wird in der Regel über `_label` bereitgestellt.
...
<ComboboxPreview context="feature" visibleProperties={['_label']} />
...
<ComboboxPreview context="feature" visibleProperties={['_disabled', '_required', '_touched']} />
...
<ComboboxPreview
	...
	initialProps={{ _msg: 'Die Programmiersprache ist erforderlich.' }}
/>
...
<ComboboxPreview context="feature" visibleProperties={['_icons']} initialProps={{ _icons: 'kolicon-cogwheel' }} />

#### Clear-Button

Der Clear-Button kann über `_hasClearButton` gesteuert werden (standardmäßig aktiviert):

<ComboboxPreview context="feature" visibleProperties={['_hasClearButton']} initialProps={{ _hasClearButton: true }} />

#### Versteckte Beschriftung

Die Beschriftung kann über `_hideLabel` visuell verborgen werden (bleibt für Screenreader sichtbar):

<ComboboxPreview context="feature" visibleProperties={['_hideLabel']} initialProps={{ _hideLabel: true }} />
