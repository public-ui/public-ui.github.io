...
import Readme from '@site/readmes/nav/readme.md';
...
<NavPreview context="example" initialProps={{}} />
...
<NavPreview
	context="feature"
	visibleProperties={['_links']}
	initialProps={{
		_label: 'Navigation',
		_links: [
			{ _href: '#start', _label: 'Startseite' },
			{ _href: '#about', _label: 'Über uns' },
		],
	}}
/>
...
<NavPreview
	...
	initialProps={{
		_label: 'Navigation',
		_links: [
			{ _href: '#start', _icons: 'kolicon-housekolibri', _label: 'Startseite' },
			{
				_icons: 'kolicon-house',
				_label: 'Oberseite',
				_children: [
					{ _href: '#start/sub1', _icons: 'kolicon-house', _label: '1. Unterseite' },
					{ _href: '#start/sub2', _icons: 'kolicon-house', _label: '2. Unterseite' },
				],
			},
