...
| Kein eigener Datepicker bzw. Zeitwähler | Die Komponente nutzt die nativen Auswahldialoge des Browsers bzw. Betriebssystems. Darstellung, Tastatur- und Screenreader-Unterstützung des Dialogs hängen daher von der jeweiligen Plattform ab. |
