...
> Die EUPL ist in der Liste der freigegebenen Open Source-Lizenzen bei OpenCoDE gelistet: <KolLink _href="https://wikijs.opencode.de/de/Hilfestellungen_und_Richtlinien/Lizenzcompliance" _target="blank" />
