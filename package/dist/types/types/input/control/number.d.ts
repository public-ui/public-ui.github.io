...
export declare type InputDateType = 'date' | 'datetime-local' | 'month' | 'time' | 'week';
export declare type InputNumberType = 'number' | InputDateType;
export declare type OptionalInputProps<T> = {
  accessKey: string;
  alert: boolean;
