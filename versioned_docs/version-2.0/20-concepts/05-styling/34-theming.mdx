...
<p>
	...
	assistiven Unterstützung sind. Alle Komponenten werden dabei als <KolLink
...
<p>
	Im ersten Release (v1.0) hatte <KoliBri /> noch direkt das Individualisieren des Standard-Designs mittels sogenannter <strong><KolLink
		_href="https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties"
		_target="mozilla"
		_label={`CSS-Properties`}
	/></strong> (<KolLink _href="https://uxdesign.cc/design-tokens-for-dummies-8acebf010d71" _target="uxdesign" _label="Design-Tokens"></KolLink>, <KolLink _href="https://tailwindcss.com" _target="tailwindcss" _label={`Tailwind CSS`} />) umgesetzt. Mit der
...
<p>
	<KolIndentedText>
		<strong>
			2. Wir haben das ganze CSS vollständig von den Components entkoppelt (wie <KolLink _href="https://styled-components.com" _target="styled-components" _label={`Styled-Components`} />).
		</strong>
	</KolIndentedText>
</p>
<p>
...
<p>
	...
	Spezifikation in die Realisierung wird das Design in Form von reinem CSS mittels des <KolLink _href="/docs/concepts/styling/designer" _label={`KoliBri-Designers`} /> auf die Basis-Komponenten
...
<KolAlert _label="KoliBri-Factory" _type="info" _variant="card">
	<p>
		...
		Hierfür bieten wir die sogenannte <strong>KoliBri-Factory</strong> (Stack) an (siehe <KolLink
