...
In der <kol-abbr _label="Single-Page-Application">SPA</kol-abbr>-Entwicklung wird hier oft in den <i>Template-driven</i>- und
...
Die **Eingabe**-Komponenten sind die Komponenten mit den Formular-Eingaben gemacht werden können. Sprich in erster Linie <kol-link _href="/docs/konzepte/formular-input" _label="Inputs, Select und Textarea"></kol-link>.
