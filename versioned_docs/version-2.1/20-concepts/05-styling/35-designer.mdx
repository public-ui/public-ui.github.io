...
<div className="grid grid-cols-2">
	<KolCard _label="Eigenes Theme erstellen" _level={2}>
		<KolLink _label="Klicken Sie hier, um den Designer in einem neuen Browser-Fenster zu öffnen." _href="/designer" _target="blank" _icons={{ left:'codicon codicon-paintcan' }} />
	</KolCard>
</div>
