...
| `_variant`            | `_variant`          | <span className="text-red-500">**[DEPRECATED]**</span> Use the new _inline property instead.<br/><br/>Defines which variant should be used for presentation.                                                                                    | `"inline" \| "standalone" \| undefined`                                                                                                                | `'inline'`  |
