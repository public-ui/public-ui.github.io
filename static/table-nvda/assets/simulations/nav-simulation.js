...
if (navTest) {
	navTest._links = [
		...
		},
		{
			...
			_icon: 'fa-solid fa-fire',
			_children: [
				{ _label: '3.1 Navigationspunkt', _href: '#abc', _icon: 'fa-solid fa-fire' },
				{ _label: '3.2 Navigationspunkt', _href: '#abc', _icon: 'fa-solid fa-fire', _target: 'asdasd' },
				{
					_icon: 'fa-solid fa-fire',
					_label: '3.3 Navigationspunkt',
					_href: '#abc3.3',
					_children: [
						{ _icon: 'fa-solid fa-fire', _label: '3.3.1 Navigationspunkt', _href: '#abc' },
						{ _icon: 'fa-solid fa-fire', _label: '3.3.2 Navigationspunkt', _href: '#abc' },
					],
				},
				{
					_icon: 'fa-solid fa-fire',
					...
					_href: '#abc3.4',
					_children: [
						{ _icon: 'fa-solid fa-fire', _label: '3.4.1 Navigationspunkt', _href: '#abc' },
						{ _icon: 'fa-solid fa-fire', _label: '3.4.2 Navigationspunkt', _href: '#abc' },
					],
				},
				{ _icon: 'fa-solid fa-fire', _label: '3.5 Navigationspunkt', _href: '#abc' },
			],
		},
		{
			...
			_icon: 'fa-solid fa-fire',
			_children: [
				{ _label: '4.1 Navigationspunkt', _href: '#abc', _icon: 'fa-solid fa-fire' },
				{ _label: '4.2 Navigationspunkt', _href: '#abc', _icon: 'fa-solid fa-fire', _target: 'asdasd' },
				{
					_icon: 'fa-solid fa-fire',
					_label: '4.3 Navigationspunkt',
					_href: '#abc',
					_children: [
						{ _icon: 'fa-solid fa-fire', _label: '4.3.1 Navigationspunkt', _href: '#abc' },
						{ _icon: 'fa-solid fa-fire', _label: '4.3.2 Navigationspunkt', _href: '#abc' },
					],
				},
				{
					_icon: 'fa-solid fa-fire',
					...
					_href: '#abc',
					_children: [
						{ _icon: 'fa-solid fa-fire', _label: '4.4.1 Navigationspunkt', _href: '#abc' },
						{ _icon: 'fa-solid fa-fire', _label: '4.4.2 Navigationspunkt', _href: '#abc' },
					],
				},
				{ _icon: 'fa-solid fa-fire', _label: '4.5 Navigationspunkt', _href: '#abc' },
			],
		},
	];
}
...
function populateNavFromElements(nav, elements, numberOfChildren) {
	...
	elements.forEach((c) => {
		...
		if (counter === 0) {
			...
			currentParent = { _label: `Komponente ${n + 1} bis ${n + numberOfChildren}`, _icon: 'fa-solid fa-fire', _children: [] };
