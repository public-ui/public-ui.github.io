...
| `_type`               | `_type`    | <span className="text-red-500">**[DEPRECATED]**</span> will be removed in v2, use _variant<br/><br/>Defines which variant should be used for presentation. | `"bar"` \| `"cycle"` \| `"cycle-label-value"` \| `"cycle-value-label"` \| `undefined` | `undefined` |
