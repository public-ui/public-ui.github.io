...
| `_max`               | `_max`               | Defines the maximum number of pages.                                                                               | `number` \| `undefined`                                                                                                                                                                                                  | `undefined` |
...
| `_total`             | `_total`             | <span className="text-red-500">**[DEPRECATED]**</span> Use _max.<br/><br/>Setzt die Gesamtanzahl der Seiten.              | `number` \| `undefined`                                                                                                                                                                                                  | `undefined` |
