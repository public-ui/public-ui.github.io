...
<kol-input-checkbox _id="checkbox"
	>Ich stimme der
	<kol-link _href="#" _label="Datenschutzerklärung" _target="document"></kol-link> zu.</kol-input-checkbox
>
...
| `_type`          | `_type`          | <span className="text-red-500">**[DEPRECATED]**</span> Verwende stattdessen das Attribute \_variant.<br/><br/>Gibt an, welchen Type das Input haben soll. | `"button"` \| `"checkbox"` \| `"default"` \| `"switch"` \| `undefined`                                                                                                                                                                                                                                                        | `undefined` |
| `_value`         | `_value`         | Gibt den Schlüssel/Namen der Checkbox an.                                                                                                                 | `string` \| `undefined`                                                                                                                                                                                                                                                                                                       | `undefined` |
