...
<KolTable
	className="col-12"
	_caption="List of status values for the packages"
	_minWidth="95em"
	_headers={{
		horizontal: [
			[
	...
	<img alt="" slot="expert" src="https://img.shields.io/npm/dt/${getPackageName(tupel.scope, tupel.name)}.svg" />
				...
				},
				{
					...
					key: 'name',
					textAlign: 'center',
					render: () => `<img alt="" slot="expert" src="https://packagequality.com/shield/create-kolibri.svg" />`,
				},
				{
					label: 'Install size',
					key: 'name',
