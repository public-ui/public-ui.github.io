...
NPM `npm i @public-ui/components @public-ui/themes` or

PNPM `pnpm i @public-ui/components @public-ui/themes` or

YARN `yarn add @public-ui/components @public-ui/themes`
