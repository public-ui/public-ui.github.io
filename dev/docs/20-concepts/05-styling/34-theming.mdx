...
<KolAlert _heading="KoliBri-Factory" _type="info" _variant="card">
	<p>
		Eigene spezifische Komponenten, die nicht von KoliBri bereitgestellt werden und leider nicht zur KoliBri-Komponenten-Vielfalt passen, können in eigenen Komponenten-Bibliotheken aufgebaut und unabhängig gepflegt werden. Hierfür bieten wir die sogenannte <strong>KoliBri-Factory</strong> (Stack) an (siehe <KolLink _href="https://github.com/public-ui/kolibri/blob/main/docs/ARCHITECTURE.md#erweitert" _target="github">
			Modularisierung
		</KolLink>).
	</p>
</KolAlert>
