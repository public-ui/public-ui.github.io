...
> Die EUPL ist in der Liste der freigegebenen Open Source-Lizenzen bei OpenCoDE gelistet: <kol-link _href="https://wikijs.opencode.de/de/Hilfestellungen_und_Richtlinien/Lizenzcompliance" _target="opencode"></kol-link>
