...
- 🤗 Die reine Wiederverwendung der Artefakte ist vollkommen **unproblematisch**! - <small>Internet Projekte können Closed-Source bleiben.</small>
- 🤔 **Achtung** beim Kopieren von Code! _(zieht **Copyleft** nach sich)_ - <small>Kopien/Forks einfach vom internen Projekt separieren und veröffentlichen.</small>
