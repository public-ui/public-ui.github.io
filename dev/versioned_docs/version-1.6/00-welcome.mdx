...
<p className="col-12">
	...
	ohne Weiteres barrierefrei, semantisch und valide sind. <KoliBri /> baut direkt auf den <kol-link
		...
		_target="w3c"
		_label="Webstandards"
	></kol-link> des <kol-link _href="https://www.w3.org" _target="w3c" _label="W3C"></kol-link> auf (Framework-agnostisch),
	...
	></kol-link> und der <kol-link _href="https://www.bitvtest.de/bitv_test.html" _target="bitv" _label="BITV"></kol-link>{' '}
