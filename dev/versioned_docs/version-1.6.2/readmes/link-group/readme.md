...
| `_ordered`            | `_ordered`         | <span className="text-red-500">**[DEPRECATED]**</span> Wird mittels der Property \_list-style-type automatisch gesteuert.<br/><br/>Deprecated: Gibt an, ob eine Ordered- oder eine Unordered-List verwendet werden soll. | `boolean` \| `undefined`                                                                                                                                                                                                                        | `undefined`  |
