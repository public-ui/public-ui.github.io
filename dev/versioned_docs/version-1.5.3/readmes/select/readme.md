...
| `_height`            | `_height`     | <span className="text-red-500">**[DEPRECATED]**</span> Use \_size instead.<br/><br/>Gibt an, ob eine individuelle Höhe übergeben werden soll. | `string` \| `undefined`                                                                                         | `undefined` |
