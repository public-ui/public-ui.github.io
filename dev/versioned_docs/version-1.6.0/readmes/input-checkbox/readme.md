...
<kol-input-checkbox _id="checkbox"
	>Ich stimme der
	<kol-link _href="#" _label="#" _label="Datenschutzerklärung" _target="document"></kol-link> zu.</kol-input-checkbox
>
...
| `_type`               | `_type`          | <span className="text-red-500">**[DEPRECATED]**</span> Verwende stattdessen das Attribute \_variant.<br/><br/>Deprecated: Defines which variant should be used for presentation. | `"button"` \| `"checkbox"` \| `"default"` \| `"switch"` \| `undefined`                                                                                                                                                                                                                                                        | `undefined` |
| `_value` _(required)_ | `_value`         | Defines the value of the input.                                                                                                                                                  | `boolean` \| `null` \| `number` \| `object` \| `string` \| `undefined`                                                                                                                                                                                                                                                        | `undefined` |
