...
Mit der CSS-Definition `display: contents;` am `kol-icon`-Tag wird das Icon passend ausgerichtet. Die Ausrichtung der der Icon-Komponente innerhalb anderer Komponenten hängt immer von der jeweiligen Verwendung ab.
