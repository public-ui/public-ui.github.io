---
slug: eigene-themes-unabhaengig-umsetzen
...
Ein besonders großer Vorteil von KoliBri liegt in seiner besonders guten Wiederverwendbarkeit und hohen Flexiblität. Denn auf
Basis der semantisch barrierefreien Komponenten, in denen zahlreiche technische und gesetzliche Anforderungen (alle) umgesetzt
...
<KolTable
	_caption="Liste ausgewählter internen Themes"
	_headers={{
		horizontal: [
			[
				{
...
Darüber hinaus wurden auch einige Themes für zum Zwecke der Verbesserung umgesetzt, die als Proof-of-Concepts (PoC) dienten.

<KolTable
	_caption="Liste ausgewählter PoC-Themes"
	_headers={{
		horizontal: [
			[
				{
	...
	_data={[
		...
		{
			name: 'TH',
			usage: 'Umsetzung des Styleguides des Freistaates Thüringens als Proof-of-Concept zur Verifizierung und Verbesserung der KoliBri-Komponenten',
		},
	]}
/>
...
Damit die entwickelnden Projekt jetzt das neue Theme-Paket installieren und verwenden können, muss zunächst die NPM-Konfiguration <code>.npmrc</code>
...
In diesem Abschnitt einen kurzen Einblick geben, wie einfach es ist, ein eigenes Theme zu erstellen.
...
kann einfach die passende Teilmenge aus KoliBri ausgewählt und wiederverwendet werden. Alle nicht vereinbaren Komponenten
