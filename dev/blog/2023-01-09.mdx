...
Hier gibt es auch ein kleines Code-Beispiel zum <kol-link _href="https://codesandbox.io/s/kolibri-sample-react-link-sample-1jgz8v?file=/src/Navigation.tsx:0-112" _label="Navigieren mit React-Router" _target="sandbox"></kol-link>.
