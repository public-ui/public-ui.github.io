...
The **input** components are the components that can be used to make form inputs. That means primarily <kol-link _href="/en/docs/konzepte/formular-input">inputs, select and textarea</kol-link>.
