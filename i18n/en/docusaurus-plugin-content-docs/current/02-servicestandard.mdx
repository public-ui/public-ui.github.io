...
description: How KoliBri operationalises the quality requirements of the Servicestandard (DIN SPEC 66336) for digital public services through standardised and accessible components.
tags:
  - accessibility
  - standards
  - DIN SPEC 66336
...
For principle 6, the Servicestandard (DIN SPEC 66336) requires compliance with [BITV 2.0]. This implements the European standard [EN 301 549], which in turn includes [WCAG 2.1] (level AA). KoliBri meets these requirements through the construction of the components:
