...
import Readme from '@site/readmes/breadcrumb/readme.md';
...
<BreadcrumbPreview context="example" />
...
- **`_icons`** (optional) passes the name of the icon if an icon should be displayed in addition to the text of the element. <kol-link _href="https://develop--kolibri-public-ui.netlify.app/#/icon/all-kolicons" _target="_blank" _label="Kolicons"></kol-link> and <kol-link _href="https://fontawesome.com" _target="_blank" _label="Font Awesome"></kol-link> are available.
- **`_hide-label`** (optional). If the value is set to **true**, only the icon appears in the link, without any other text. The `_icons` property must be set.
