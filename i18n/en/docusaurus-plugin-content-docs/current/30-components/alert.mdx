...
import Readme from '@site/readmes/alert/readme.md';
...
<AlertPreview context="example" initialProps={{ _label: 'Notice', _type: 'info', _variant: 'msg' }} />
...
<AlertPreview context="playground" />
...
<AlertPreview context="feature" visibleProperties={['_type']} initialProps={{ _label: 'Notice', _type: 'info' }} />
...
<AlertPreview context="feature" visibleProperties={['_slot']} initialProps={{ _label: 'Notice', _type: 'info' }} />
