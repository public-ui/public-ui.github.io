...
<InputDatePreview context="example" initialProps={{ _label: 'Date of birth' }} />
...
<InputDatePreview context="feature" visibleProperties={['_type']} initialProps={{ _label: 'Date', _type: 'date' }} />
