...
<AccordionPreview context="example" initialProps={{ _open: true }} />
...
<AccordionPreview context="playground" />
...
<AccordionPreview context="feature" visibleProperties={['_label', '_slot']} />
