...
import Readme from '@site/readmes/split-button/readme.md';
...
<SplitButtonPreview context="example" />
...
<SplitButtonPreview context="playground" />
...
<SplitButtonPreview context="feature" visibleProperties={['_label']} />

#### Variants

The Split-Button supports various visual variants for different contexts:

<SplitButtonPreview context="feature" visibleProperties={['_variant']} initialProps={{ _variant: 'primary' }} />
...
<SplitButtonPreview context="feature" visibleProperties={['_icons', '_hideLabel']} />

#### Tooltip and Keyboard Shortcuts

Configure tooltip position and keyboard shortcuts:

<SplitButtonPreview context="feature" visibleProperties={['_tooltipAlign', '_shortKey']} />

#### Disabled State

The Split-Button can be disabled via `_disabled`:

<SplitButtonPreview context="feature" visibleProperties={['_disabled']} initialProps={{ _disabled: true }} />
