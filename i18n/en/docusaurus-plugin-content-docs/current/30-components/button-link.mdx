...
<ButtonLinkPreview context="example" initialProps={{ _label: 'Button looks like a link' }} />
...
<ButtonLinkPreview context="feature" initialProps={{ _label: 'Works like a button' }} visibleProperties={['_label']} />
