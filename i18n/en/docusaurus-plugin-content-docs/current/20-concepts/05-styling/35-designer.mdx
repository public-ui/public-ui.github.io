...
<KolLink _label="Guide in the KERN Developer Kit" _href="https://gitlab.opencode.de/kern-ux/kern-developer-kit/-/blob/main/CONTRIBUTING.md" _target="_blank" _icons={{ left: 'fa-solid fa-code-branch' }} />
</KolCard>
</div>
