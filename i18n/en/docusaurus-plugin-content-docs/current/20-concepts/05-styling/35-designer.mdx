...
Creating a custom theme now happens entirely in a Git repository. The approach follows the documentation in the [KERN Developer Kit](https://gitlab.opencode.de/kern-ux/kern-developer-kit/-/blob/main/CONTRIBUTING.en.md).
