...
> The <KolLink _label="privacy policy" _href="/en/docs/legal-notice#privacy" /> regarding the open source approach is described in a separate document.

## Introduction

The component library KoliBri has an obvious and focused target area of its technical functional expression, which is described in detail in the <KolLink _label="manifest" _href="/en/docs/manifest" />.
