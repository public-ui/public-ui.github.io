...
<KolLink _label="Frameworks" _href="/docs/get-started/frameworks" /> page.
...
The theme is passed as the first parameter when calling `register()`. To switch between
multiple themes at runtime, you can pass an array of themes and control the selection via a switch.
...
// Or register multiple themes and switch later:
// register([DEFAULT, ECL_EC, ECL_EU], defineCustomElements);
```

You can try out and switch the themes of this page live using the switch in the toolbar at the top.
...
<KolLink _label="Create theme yourself" _href="/docs/concepts/styling/designer" />
...
- [Create custom theme](/docs/concepts/styling/designer)
...
found in the <KolLink _label="component documentation" _href="/docs/components" />.
